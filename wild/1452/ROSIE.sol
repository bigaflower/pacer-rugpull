/*
    ...
    Paul S. Conyngham adopted Rosie in 2019 but just 5 years later Rosie was tragically diagnosed with a deadly cancer.
    Instead of giving up, Paul used chatGPT and other AI to help him map Rosie's DNA sequence with the help of the university of NSW. Thus Team Rosie was formed.
    Ultimately, they were able to produce a custom mRNA vaccine specifically fitting Rosie's needs thanks to AI
    So far it has worked but Paul says in the article that is has been a costly process and there's more a lot more work to be done.

    https://rosiedog.vip
    https://x.com/MedicTeamRosie
    https://t.me/MedicTeamRosie
*/
...
contract ROSIE is ERC20, Ownable {
    ...
    constructor() ERC20("Rosie The Dog", "ROSIE") payable {
