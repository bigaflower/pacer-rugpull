...
contract WorldCupMarioInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("World Cup Mario Inu", "WCMI") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x4B024A7e1B13B192E088eaC44Df86eAb49A3A480); // marketing wallet
        devWallet = address(0x4B024A7e1B13B192E088eaC44Df86eAb49A3A480); // dev wallet
