...
contract Vibra is ERC20, Ownable {
    ...
    constructor(string memory name,string memory symbol, address owner) ERC20(name,symbol) Ownable(owner)  {
        uint256 value =  1000000000*10**decimals();
        _mint(owner,value);
        emit TokensMinted(owner, value);
