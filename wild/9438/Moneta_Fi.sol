...
contract Moneta_Fi is ERC20, ERC20Burnable, Ownable2Step {
    ...
    {
        address supplyRecipient = 0x6942005B89Ab4E14e23FCD90EF782C1927CE6589;

        updateSwapThreshold(50);

        taxwalletAddressSetup(0x6942005B89Ab4E14e23FCD90EF782C1927CE6589);
        taxwalletFeesSetup(2000, 4000, 200);
        ...
        _transferOwnership(0x6942005B89Ab4E14e23FCD90EF782C1927CE6589);
