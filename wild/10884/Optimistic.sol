...
Optimistic Minion. The newest viral reaction image. We could all use some optimism.

https://x.com/i/communities/2034771455460954409/
...
contract Optimistic is ERC20, Ownable {
    ...
    constructor() ERC20("Optimistic Minion", "Optimistic") payable {
