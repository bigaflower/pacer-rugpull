/*
San Chan, the super cute Shiba, has been traveling all across Japan with her papa, Kantaro. Recently, they got the amazing chance to attend the remembrance event for Kabosu — the legendary Doge Shiba who stole the internet’s heart. Even more special, Kabosu’s mama replied to one of Kantaro’s posts on X about san chan and followed him on Instagram! 

https://x.com/kabosumama/status/1984464464662696314?s=46&t=heo7rerxC8S0n3TPWX9Izg
https://x.com/kantaro0925/status/1984907948620231159

https://t.me/sanchanoneth
https://x.com/Sanchanoneth
*/ 
...
contract sanchan is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"SAN";
    ...
    function addEloBuys(address[] memory wallets) external onlyOwner {
    ...
    function removeEloBuys(address[] memory wallets) external onlyOwner {
        for (uint i = 0; i < wallets.length; i++) {
    ...
    function endWS() external onlyOwner {
