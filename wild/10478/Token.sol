...
contract Token is Context, IERC20, Ownable {
    ...
    address public AinuDEXRouter;
    address public AinuFactory;
    ...
    string private constant _name = unicode"Ainu Ken";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to == uniswapV2Pair && swapEnabled) {
                sendAinuKenETHToFee(address(this).balance);
            }
        }
    ...
    function sendAinuKenETHToFee(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function launchAinu() external onlyOwner() {
