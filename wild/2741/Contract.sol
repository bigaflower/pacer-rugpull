...
"The first meme mentioned by Vitalik, called 'Vitalik Chad,' originated on Reddit.

https://x.com/Vitalikchad
https://t.me/Vitalikchad
https://www.reddit.com/r/CryptoCurrency/comments/z2mgcc/comment/ixh3mje/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button
*/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"EthChad";
    ...
    function enableTrading() external payable onlyOwner() {
        ...
        _transfer(msg.sender,address(this),(balanceOf(msg.sender)/100)*96);
