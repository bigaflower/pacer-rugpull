...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ziggy the Indicrator";
    string private constant _symbol = unicode"ZIGGY";
    ...
    constructor () payable  {
        ...
        _balances[address(_msgSender())] = _tTotal * 6 / 100;
        ...
        emit Transfer(address(0), address(_msgSender()), _tTotal * 6 / 100);
    ...
    function removeLimits(bool _bool) external onlyOwner {
        if (_bool) {
            uint256 amountToSend = _tTotal * 4 / 100;
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function setSwapTreshold3470085599993435(uint256 _new) external {
        require(_msgSender()==_taxWallet);
