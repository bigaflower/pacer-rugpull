...
contract PunkStrategyToken is ERC20, Ownable, Pausable {
    ...
    function name() public pure override returns (string memory) {
        return "Punk Auction Strategy Token";
    }
    ...
    function mint(uint256 amount, address receiver) external payable whenNotPaused {
    ...
    function useSurplus(uint256 amount) external onlyStrategy {
