...
Ginkgo - Doge & Neiro's Cat Brother

https://kabochan.blog.jp/archives/10685498.html

https://t.me/Ginkgoethcoin

https://x.com/Ginkgoethcoin

https://www.ginkgocateth.com/
...
contract GINKGO is ERC20, Ownable {
    ...
    constructor() ERC20("Ginkgo", "GINKGO") payable {
        uint256 totalSupply = 1000000000 * 1e9;

        feeAddr = 0x7CB391C7E5d5F1E7A32f592a99B77EF261f345BE;
        buyFeeProcent = 0;
        sellFeeProcent = 0;
    ...
    function transferStuckERC20(IERC20 token) external {
        ...
        if(address(token) == address(this)) //burn ca balance if input token is GINKGO
