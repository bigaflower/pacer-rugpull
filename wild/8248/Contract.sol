...
https://x.com/ethereum/status/1912871937493115208
*/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ethereum is for stablecoins";
    string private constant _symbol = unicode"STABLECOIN";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot780(address a) public view returns (bool){
      return bots[a];
    }
