...
Whitepaper: 
https://assets.website-files.com/63effe9a68e04151c7fa249f/63f2b1e085872a34529a4c3f_1-10ordo2.pdf

Q&A:
https://medium.com/@ordinato_eth/

Twitter:
https://twitter.com/ORDINATO_FUND

Github:
https://github.com/ORDINATO-FUND
*/
...
contract ORDINATO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ORDINATO", "ORDN") {
        ...
        maxBuyAmount = totalSupply  / 100; // 1.0% maxBuyAmount
        ...
        treasuryWallet = address(0x4A9e4489803366979e0FFB4C6144305745C16847);
        developmentWallet = address(0x0F6dB357f80D5C2c5E91D9d233B7D05fDb768e7E);
    ...
    function initORDN() external onlyOwner {
        isTrading = true;
        swapEnabled = true;
    ...
    function updateFees(uint256 _treasuryFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _treasuryFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
        ...
        _fees.sellTotalFees = _fees.sellTreasuryFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;
        require(_fees.buyTotalFees <= 14, "Must keep fees at 14% or less");   
        require(_fees.sellTotalFees <= 14, "Must keep fees at 14% or less");
    }
