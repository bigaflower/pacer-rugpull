...
contract MaxAPY is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public _name = "MaxAPY";
    string public _symbol = "MaxAPY";
    ...
    uint256 public MaxAPYInsuranceFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public InfernoFee = 25;
    uint256 public totalFee =
        liquidityFee.add(VaultFee).add(MaxAPYInsuranceFundFee).add(InfernoFee);
    ...
    address public MaxAPYInsuranceFundReceiver;
    ...
    uint256 public _initRebaseMaxAPYtTime;
    ...
    constructor() ERC20Detailed("MaxAPY", "MaxAPY", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xDeFe9E163D81fB4eeD6FB2C3B89f2f448F79643B;
        VaultReceiver = 0x8E94a64B9ee80889e874aA60834da66383027256;
        MaxAPYInsuranceFundReceiver = 0xDeFe9E163D81fB4eeD6FB2C3B89f2f448F79643B;
        Inferno = 0x8E94a64B9ee80889e874aA60834da66383027256;

        address newOwner = 0x8061D7e6fd3bc85267f92b2F2357c22c70e23404;
        ...
        _initRebaseMaxAPYtTime = block.timestamp;
    ...
    function rebase() internal {
        if (inSwap) return;
        uint256 rebaseRate;
        uint256 deltaTimeFromInit = block.timestamp - _initRebaseMaxAPYtTime;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(
                _VaultFee.add(MaxAPYInsuranceFundFee)
            )
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(VaultReceiver).call{
            value: amountETHToVaultAndSIF.mul(VaultFee).div(
                VaultFee.add(MaxAPYInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(MaxAPYInsuranceFundReceiver).call{
            value: amountETHToVaultAndSIF.mul(MaxAPYInsuranceFundFee).div(
                VaultFee.add(MaxAPYInsuranceFundFee)
            ),
            gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _MaxAPYInsuranceFundReceiver,
        address _Inferno
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        VaultReceiver = _VaultReceiver;
        MaxAPYInsuranceFundReceiver = _MaxAPYInsuranceFundReceiver;
        Inferno = _Inferno;
    }
    ...
    function changeFees(
        ...
        uint256 _VaultFee,
        uint256 _MaxAPYInsuranceFundFee,
        uint256 _sellFee,
        uint256 _InfernoFee
    ) external onlyOwner {
        liquidityFee = _liquidityFee;
        VaultFee = _VaultFee;
        MaxAPYInsuranceFundFee = _MaxAPYInsuranceFundFee;
        sellFee = _sellFee;
        InfernoFee = _InfernoFee;
        totalFee = _liquidityFee
            .add(_VaultFee)
            .add(_MaxAPYInsuranceFundFee)
            .add(_InfernoFee);
