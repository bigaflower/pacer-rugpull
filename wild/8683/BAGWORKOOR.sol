...
contract BAGWORKOOR is ERC20, Ownable {
    ...
    string private constant _ConstructSymbol = "BAGWORKOOR";

    constructor() ERC20(unicode"THE BAGWORKOOR", unicode"BAGWORKOOR") payable {
