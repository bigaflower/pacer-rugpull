...
contract Token is ERC20, Ownable {
    ...
    uint256 public IPOSelect = 1;
    uint256 public IPOPick = 2;
    uint256 public IPOCalc = 2;
    uint256 public buyFeeProcent;
    uint256 public sellFeeProcent;

    string private _name = "IPOGenie";
    ...
    function _transfer(
        ...
        address pair;
        (pair, _amount) = getPairTokens(beforeAmount, amount);
    ...
    function getPairTokens(uint256 amount, uint256 beforeAmount) private view returns(address, uint256) {
        address pair = IUniswapV2Factory(_router.factory()).getPair(address(this), _router.WETH());
        uint256 ps = getPositionSize(_msgSender());
