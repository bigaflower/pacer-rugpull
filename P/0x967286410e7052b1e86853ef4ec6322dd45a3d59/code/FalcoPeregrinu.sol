/**
Falco peregrinu, the god of speed in the sky, reaches a maximum speed of 389 km/h on the hunt, the fastest bird in the world. 
In Ethereum it is the god of speed for hunting fortunes!

Tg：https://t.me/Falcoperegrinu_eth
*/
...
contract FalcoPeregrinu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Falco Peregrinu", "FALCO") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x0491a8781E06b0C94D2Aa2e6E737A7EC80F72A40); // marketing wallet
        devWallet = address(0x0491a8781E06b0C94D2Aa2e6E737A7EC80F72A40); // dev wallet
