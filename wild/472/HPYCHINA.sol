/*
  ...
  Bing Wu 丙午 (Year of the Fire Horse)🔥🐴

  https://t.me/BingWuCoin
  https://bingwu.sbs/
  https://x.com/BingWuETH
...
contract HPYCHINA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bing Wu 丙午";
    string private constant _symbol = unicode"FireHorse";
    uint256 public _taxSwapThreshold= (_tTotal * 5 ) / 10000;
    uint256 public _maxTaxSwap= _taxSwapThreshold * 18;
