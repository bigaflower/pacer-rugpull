...
Telegram: https://t.me/blepetheblue
Twitter: https://x.com/blepetheblue
Website: https://www.blepetheblue.com/
...
contract BLEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Blepe the Blue";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        uint256 taxAmount = 0;
        if (firstBlock > 0 && block.number > firstBlock + 15) {
            removeLimits();
        }
