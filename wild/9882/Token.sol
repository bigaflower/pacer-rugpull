...
/*
    ...
    https://btchypercoin.fun
    https://x.com/BTC_CoinHyper
    https://t.me/BTC_CoinHyper
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isHYPERkcjx2309daExcludedFromFee;
    ...
    uint256 private _DFOWEUIOPRI = 2;
    bool private _CHBKSJDGHF = false;
    string private _JKDKHHEUI = unicode"HYPER";

    constructor () payable  {
        _taxWallet = payable(0xD44C636cB5F97bD084A2eA8322d7E401Fd7E481d);
        _isHYPERkcjx2309daExcludedFromFee[owner()] = true;
        _isHYPERkcjx2309daExcludedFromFee[address(this)] = true;
        _isHYPERkcjx2309daExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isHYPERkcjx2309daExcludedFromFee[to] ) {
