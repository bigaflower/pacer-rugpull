...
contract The_Scream_1893_oil_on_canvas is ERC721AC, BasicRoyalties, Ownable, OwnableBasic {
    ...
    mapping(address => bool) public minter;
     ...
     constructor(address initialOwner, address royaltyReceiver, uint96 royaltyFeeNumerator, address _minter) ERC721AC("The Scream, 1893 (oil on canvas)", "The Scream, 1893 (oil on canvas)") 
