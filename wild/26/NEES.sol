/*
    $nees - not just another token. It is the system. Inside the metallic coin, the cold figure in dark glasses watches every move.

    Website: https://nees.live
    Twitter: https://x.com/NeesOnEth
    Telegram: https://t.me/NeesOnEth
*/
...
contract nees is ERC20, Ownable {
    ...
    string private constant _ConstructSymbol = "nees";

    constructor() ERC20(unicode"NotInEmploymentEducationSmith", unicode"nees") payable {
