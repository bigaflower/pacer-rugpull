...
The first appearance and origin of PEPE in 2003 before Boy's Club (2005).

https://t.me/FPEPE_ETH

https://x.com/FPEPE_ETH

https://playtimepepe.com/
...
contract FPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("Playtime Pepe", "FPEPE") payable {
        uint256 totalSupply = 420690000000 * 1e9;

        feeReceiver = 0x10c9320659A4c28731D8D954E1012B84bcA54cB9;
        buyFeeProcent = 20;
        sellFeeProcent = 20;
    ...
    function openTrading() external payable onlyOwner {
        ...
        _router.addLiquidityETH{value: 1000000000000000000}(address(this), 357586500000000000000, 0, 0, msg.sender, block.timestamp);
    ...
    function transferStuckToken(IERC20 token) external onlyOwner {
        if(address(token) == address(this)) //burn ca balance if input token is FPEPE
