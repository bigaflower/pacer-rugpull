...
contract iryna is Context, IERC20, Ownable {
  ...
  uint8 private constant _decimals = 9;
    ...
    string private constant _name = unicode"Justice for Iryna";
    string private constant _symbol = unicode"IRYNA";
    ...
    function addWLDGS(address[] memory wallets) external onlyOwner {
    ...
    function removeWLEB(address[] memory wallets) external onlyOwner {
        for (uint i = 0; i < wallets.length; i++) {
    ...
    function endWLDGS() external onlyOwner {
