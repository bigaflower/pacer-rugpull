...
/*
    ...
    OSCA - Open Source Creative Architecture

    This smart contract is part of the OSCA project, 
    an open-source initiative focused on building privacy-first 
    and decentralized crypto software solutions.

    Website: https://oscastack.com
    Other links:
        - Telegram:   https://t.me/oscastack  
        - X/Twitter:  https://x.com/oscastack
*/
...
contract OSCA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"OSCA Stack";
    string private constant _symbol = unicode"OSCA";
    uint256 public _taxSwap = 7000 * 10**_decimals;
