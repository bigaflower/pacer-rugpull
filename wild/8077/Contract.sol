...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"X Originals";
    string private constant _symbol = unicode"XORIGINALS";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot805(address a) public view returns (bool){
      return bots[a];
    }
