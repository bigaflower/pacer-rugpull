  ...
  /*
    The founder returns
           ...
           Searched 
              ...
              https://files.catbox.moe/erk37c.jpg
  */
...
// I may have his name tag, but I am not Him.
  interface IERC20 {
...
// I may have his wallet, but I am not Him. 
...
contract RYOSHI is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"I Am Not Ryoshi", unicode"RYOSHI") payable {
        uint256 totalSupply = 1000000000 * 1e18;

        uint256 caSupply = totalSupply.mul(25).div(100);

        maxSwapSize = totalSupply.mul(198).div(10000);
        maxWalletSize = totalSupply.mul(198).div(10000);
        feeThresholdAmount = totalSupply.mul(35).div(10000);

        feeAddr = 0x7Bae03d181970bd37aD72fA29a7A77b5422A0CA3;
