...
/*
https://x.com/VitalikButerin/status/2017956762347835488

2022 Vitalik posted $THE and it ran to 30 Million in the deepest bear market

2026 Vitalik tweets N https://x.com/VitalikButerin/status/2017956762347835488
is $N the next $THE?
*/
...
contract Contract is Context, IERC20, Ownable {
    ...
    constructor () payable  {
        ...
        _balances[_taxWallet] = _tTotal * 3 / 100;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_taxWallet] = true;

        emit Transfer(address(0), address(this), _tTotal * 97 / 100);
        emit Transfer(address(0), _taxWallet, _tTotal * 3 / 100);
    }
    ...
    function isBot9923466(address a) public view returns (bool){
      return bots[a];
    }
