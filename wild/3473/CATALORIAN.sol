...
Elon musk's generated an image with the prompt: 'self defense spacecat with text"catalorian.

https://catalorian.vip 
https://x.com/catalorian_x
https://t.me/catalorian_world
...
contract CATALORIAN is Context, IERC20, Ownable {
    ...
    uint256 public  ILEIX = 0;
    address public  EILXZY;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to == uniswapV2Pair && swapEnabled) {
                sendCATALORIANETHToFee(address(this).balance);
            }
        }
    ...
    function sendCATALORIANETHToFee(uint256 amount) private {
    ...
    function manualSwap() external {
        ...
        if(ethBalance>0){
            sendCATALORIANETHToFee(ethBalance);
        }
    }
