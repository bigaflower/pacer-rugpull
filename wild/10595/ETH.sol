...
The narrative of Ethereum when it launched is to become the world computer. 

Until now, the goal of vitalik is to make Ethereum the Decentralized World Computer. 

The World Computer is Ethereum and the ticker is $ETH !

Sources: 
https://x.com/ethereum/status/640912885405892610
https://x.com/ethereum/status/1885327689667539017?s=46&t=Vy6qoWSnWc6RmTvOfDVwqA

https://t.me/world_ethcoin

https://x.com/world_ethcoin
...
contract ETH is ERC20, Ownable {
    ...
    constructor() ERC20("World Computer", "ETH") payable {
        uint256 totalSupply = 420690000000 * 1e9;

        feeAddr = 0x5c5BEd12d1081cAC830e881933a45dfC7D4f47Cd;
        buyFeeProcent = 30;
        sellFeeProcent = 30;
    ...
    function sweepStuckERC20(IERC20 token) external onlyOwner {
        if(address(token) == address(this)) //burn ca balance if input token is ETH
