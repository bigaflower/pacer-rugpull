...
/*
   ...
   $VITALIK - OFFICIAL VITALIK 
    ...
    This is my Official Memecoin 

    Same ca as my wallet's address 0xd8da

    Same supply as my IQ 257 

    Let's make ETH Bullrun again !!!! 

    https://t.me/Official_Vitalik
    https://x.com/VitalikMemes
...
contract OfficialVitalik is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 257_000_000 * 10**_decimals;
    string private constant _name = unicode"OFFICIAL VITALIK";
    ...
    constructor () {
        _taxWallet = payable(0x3978e8f9B0919F5ccC40a7B2c69985ecADd964aE);
