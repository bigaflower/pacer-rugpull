...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isPEPENODExcludedFromFee;
    ...
    constructor () payable  {
        ...
        _isPEPENODExcludedFromFee[owner()] = true;
        _isPEPENODExcludedFromFee[address(this)] = true;
        _isPEPENODExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isPEPENODExcludedFromFee[to] ) {
