...
// File: contracts/Dominion.sol
// Dominion NFT Collection

pragma solidity ^0.8.9;



contract OrionWarsDominion is ERC721, Ownable {

    using Strings for uint256;

    // Collection configuration
    uint public mintPrice = 9000000000000000;
    ...
    constructor() ERC721("OrionWarsDominion", "OWD") {
        baseUri = "ipfs://";
    }
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(curTotalSupply + _numTokens <= maxSupply, "Supply limit reached");
        require(_numTokens <= maxMintPerTransaction, "Transaction limit exceeded");
        
        if (msg.sender != owner()) {
            require(_numTokens * mintPrice <= msg.value, "Payment insufficient");
        }
    ...
    function _beforeTokenTransfer(
        ...
        // Transfers require active trading or owner involvement
