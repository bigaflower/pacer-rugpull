...
//  
//  http://plucker.vip/
//  https://t.me/pluckertoken  
// 
//  Plucker aims to be the first place any new ERC20 participant goes to when onboarding into the ecosystem. 
//  Through simple, well written articles and a web3 incentivized learning platform, 
//  $PLCKR will bring a whole new generation of investors to help make the ERC-20 great again.
...
contract Plucker is ERC20, Ownable {
    ...
    constructor() payable ERC20("Plucker", "$PLCKR") {
