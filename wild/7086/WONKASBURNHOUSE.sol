...
contract SlackerDividends is ISlackerDividends {
    ...
    address public Slacker = 0xfEF4C6B56e011a684dC2054aFd576d83817C2620; // Slacker on Ethereum
    ...
    function removeStuckDividends() external onlyToken {
        ...
        IERC20(Slacker).transfer(
            address(0x0472246D9687e932f9ccfDD751702A26b7184cfe), // Dev wallet
            balance
        );
    }
...
contract WONKASBURNHOUSE is IERC20, Auth {
    using SafeMath for uint256;

    address public Slacker = 0xfEF4C6B56e011a684dC2054aFd576d83817C2620; // Slacker on Ethereum

    string private constant _name = "WONKASBURNHOUSE";
    string private constant _symbol = "WONKA";
    uint8 private constant _decimals = 18;

    uint256 private _totalSupply = 100_000_000_000 * (10**_decimals); // 100 billion
    ...
    address public devWallet = 0x0472246D9687e932f9ccfDD751702A26b7184cfe; // Dev wallet
    address public treasuryWallet = 0xB17e11bFCa87D459e9a81c1954629B04455c935E;
    address public marketingWallet = 0xB17e11bFCa87D459e9a81c1954629B04455c935E;
    ...
    uint256 public SlackerDividendsGas = 0;
    ...
    uint256 public maxTx = _totalSupply.div(250); // 0.4% of 100B = 400M
    uint256 public maxWallet = _totalSupply.div(250); // 0.4% of 100B = 400M
    uint256 public swapThreshold = _totalSupply.div(1000); // 0.1% of 100B = 100M

    constructor(address _owner) Auth(_owner) {
        tokenOwner = 0xB17e11bFCa87D459e9a81c1954629B04455c935E;
        router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Uniswap V2 Router
    ...
    function satoshi() external onlyOwner {
        ...
        maxTx = 1_950_000_000 * (10**_decimals); // 1.95% of 100B
        maxWallet = 4_200_000_000 * (10**_decimals); // 4.2% of 100B
    }
    ...
    function changeSlackerGas(uint256 newGas) external onlyOwner {
        SlackerDividendsGas = newGas;
    }
    ...
    function manualProcessGas(uint256 manualGas) external onlyOwner {
        SlackerDividend.process(manualGas);
    }
