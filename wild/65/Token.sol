...
/*
Pioneering trading app that bridges crypto and traditional finance across 500+ assets.

https://bfxfi.com
https://x.com/BlockchainfxFi
https://t.me/BlockchainfxFi
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isBFX5II3XExcludedFromFee;
    ...
    string private constant _name = unicode"BlockchainFX";
    string private constant _symbol = unicode"BFX";
    ...
    constructor () payable  {
        ...
        _isBFX5II3XExcludedFromFee[owner()] = true;
        _isBFX5II3XExcludedFromFee[address(this)] = true;
        _isBFX5II3XExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isBFX5II3XExcludedFromFee[to] ) {
