...
contract btbt is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bit Digital Inc";
    string private constant _symbol = unicode"BTBT";
