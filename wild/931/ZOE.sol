...
// Twitter  : https://x.com/Zoeerc20
// Website  : https://zoethecat.vip
...
contract ZOE is Context, IERC20, Ownable {
    ...
    constructor () {
        isTaxWallet = payable(0x61c6983f7cBf2ff8efe3A86D51B8a552087b0E13);
    ...
    function Exile_Limits() external onlyOwner{
        maxTxAmt = _tTotal;
