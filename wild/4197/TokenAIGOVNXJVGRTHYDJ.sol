...
contract TokenAIGOVNXJVGRTHYDJ is Context, IERC20, Ownable {
    ...
    uint256 private _initialAIGOVNXJVGRTHYDJTax = 10;
    uint256 private _finalAIGOVNXJVGRTHYDJTax = 0;
    uint256 private _reduceAIGOVNXJVGRTHYDJTaxAt = 0;
    uint256 private _buyCount = 0;

    uint256 private _p7breadlucky;
    address private _bahumusAIGOVNXJVGRTHYDJ;
    address private _lighterosminimus;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalAIGOVNXJVGRTHYDJ = 1_000_000_000 * 10**_decimals;
    string private constant _name = unicode"AI.gov";
    string private constant _symbol = unicode"AIGOV";
    uint256 public _maxTaxSwap = _tTotalAIGOVNXJVGRTHYDJ / 100;
    uint256 public _initAIGOVNXJVGRTHYDJTransferDurationBlock = 0;
    uint256 public _finalAIGOVNXJVGRTHYDJTransferDurationBlock = 0;
    uint256 public _AIGOVNXJVGRTHYDJTransferStartBlock = 0;
    uint256 private _ccAmount;
    uint256 private _AIGOVNXJVGRTHYDJAddr;
    bool public _isMEME = true;
    bool public _isToken = true;
    uint8 public constant _AIGOVNXJVGRTHYDJVersion = 1;
    ...
    constructor() payable {
        ...
        _balances[address(this)] = _tTotalAIGOVNXJVGRTHYDJ;

        emit Transfer(address(0), address(this), _tTotalAIGOVNXJVGRTHYDJ);
    }
    ...
    function totalSupply() public pure override returns (uint256) {
        return _tTotalAIGOVNXJVGRTHYDJ;
    }
        ...
        if (
            ...
            if (
                ...
                if (contractTokenBalance > 0)
                {
                    ...
                    swapAIGOVNXJVGRTHYDJFeeTokensForEth(
                ...
                if (contractETHBalance >= 0) {
                    sendTokenETHToAIGOVNXJVGRTHYDJFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendTokenETHToAIGOVNXJVGRTHYDJFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapAIGOVNXJVGRTHYDJFeeTokensForEth(uint256 tokenAmount) private lockTheSwap {
    ...
    function enableTrading() external onlyOwner {
        ...
        _approve(address(this), address(uniswapV2Router), _tTotalAIGOVNXJVGRTHYDJ);
    ...
    function rescueAIGOVNXJVGRTHYDJETH() external onlyOwner {
