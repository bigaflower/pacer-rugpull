...
/*
Piek is a gray Ankylosaurus and a secondary character in Abenteuer im Land der Dinosaurier.

https://dingopictures.fandom.com/wiki/Piek
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            taxAmount = amount
                .mul((_buyCount > _x2BQVT655) ? _x7PRXTZ : _0xFTXZ2096)
                .div(100);
            ...
            if (
                ...
                require(
                    balanceOf(to) + amount <= _x0BRXT5K5,
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                taxAmount = amount
                    .mul((_buyCount > _xGRWZ29) ? _x5NLYW9022 : _x3KLVQ5088)
                    .div(100);
            }
