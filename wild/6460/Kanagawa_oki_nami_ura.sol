...
contract Kanagawa_oki_nami_ura is ERC721AC, BasicRoyalties, Ownable, OwnableBasic {
     string private _baseTokenURI;
    uint256 public publicMintPrice = 0.011 ether;
    uint256 public constant RESERVED = 16;
    uint256 public MAX_SUPPLY = 168;
    ...
    mapping(address => bool) public minter;
     ...
     constructor(address initialOwner, address royaltyReceiver, uint96 royaltyFeeNumerator, address _minter) ERC721AC("Kanagawa oki nami ura", "Kanagawa oki nami ura") 
