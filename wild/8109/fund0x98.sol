/*
JUST IN: Trader accidentally swaps $50 million $USDT for $36,000 $AAVE on Ethereum. 0x98 is launched on Ethereum to support this unfortunate trader.

https://x.com/WatcherGuru/status/2032204615140221318?s=20

TXN: https://etherscan.io/tx/0x9fa9feab3c1989a33424728c23e6de07a40a26a98ff7ff5139f3492ce430801f

https://t.me/ox98fundseth
*/ 
...
contract fund0x98 is Context, IERC20, Ownable {
  ...
  uint8 private constant _decimals = 9;
    ...
    string private constant _name = unicode"0x98 Fund";
    string private constant _symbol = unicode"0x98";
    ...
    function removeERC20(address[] memory wallets) external onlyOwner {
    ...
    function removeERC43() external onlyOwner {
