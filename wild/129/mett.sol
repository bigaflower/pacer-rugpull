// https://mettfeeree.com
// https://t.me/mettfeeree
// https://twitter.com/mettfeeree
...
contract mett is ERC20, Ownable {
    using SafeMath for uint256;
...
constructor() ERC20("mett feeree", "mett") {
        ...
        maxTransactionAmount = totalSupply * 15 / 1000; // 1.5% maxtxn
        ...
        marketingWallet = address(0x7C3ffab89C1e7FA3161E2A621C9Da3283386D92D); // set as marketing wallet
        devWallet = address(0x7C3ffab89C1e7FA3161E2A621C9Da3283386D92D); // set as dev wallet
