...
contract nemesis is Context, IERC20, Ownable {
    ...
    string private _symbol = "$REVENGE";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x911a85cdd832fbE979A2a1d44B84C8734431D688);
    address payable public operationsWallet =  payable(0x911a85cdd832fbE979A2a1d44B84C8734431D688);
    ...
    // distribution ratio
    uint256 public _liquiditySharePercentage = 60;
    uint256 public _operationsSharePercentage = 40;
