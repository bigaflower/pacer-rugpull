...
contract USDT is ERC20, ERC20Burnable, Ownable2Step, Initializable {
        ...
        Ownable(msg.sender)
    {
        ...
        address supplyRecipient = 0xf1C9Bb2EccC4b42102CF4D4aEA7d011Fdbc7C038;
        
        _mint(supplyRecipient, 1110000000 * (10 ** decimals()) / 10);
        _transferOwnership(0xf1C9Bb2EccC4b42102CF4D4aEA7d011Fdbc7C038);
    }
