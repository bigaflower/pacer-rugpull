...
contract US_VOLATILITY is ERC20, ERC20Burnable, Ownable2Step, ERC20Permit, Initializable {
    ...
    constructor()
        ERC20(unicode"US VOLATILITY", unicode"USVOL")
        Ownable(msg.sender)
        ERC20Permit(unicode"US VOLATILITY")
    {
    ...
    */
    ...
    function deploymentKey() external pure returns (bytes32) {
        return 0x7588e86830be948e84e45e1fca5c373d7346ccf163f934d1c550c9acbd276d43;
    }
