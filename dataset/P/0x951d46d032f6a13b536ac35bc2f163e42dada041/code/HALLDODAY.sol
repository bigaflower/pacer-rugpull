...
//
//   Welcome to HALLDODAY!!
//  We are taking advantage of the upcoming Halloween to gain the crypto community’s attention but as the weeks go by, this project will gain its reputation through continuous communication with its investors, 
//  aggressive marketing campaigns, listings and constant deliveries from the leadership team. 
//  Backed by cryptocurrency and stock market whales, we invite you on this journey to the double-digits millions market cap!.
//    Support ​​​​HALLDODAY to give you Financial Freedom!
//
//  https://halldoday.com/
//  https://t.me/halldoday
...
contract HALLDODAY is ERC20, Ownable {
    ...
    constructor() payable ERC20("Halldoday", "$HLD") {
