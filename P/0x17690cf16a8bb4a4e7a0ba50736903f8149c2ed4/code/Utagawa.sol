//https://medium.com/@utagawakuniyoshi
...
contract Utagawa is Context, IERC20, Ownable {
    ...
    string private constant _name = "Utagawa Kuniyoshi";
    string private constant _symbol = "Utagawa";
