/*
    ...
    Website : https://nimbuschat.ai/
    Twitter : https://x.com/NimbusChatAI
    TG      : https://t.me/Nimbus_AI
...
contract NimbusAI is Ownable, ERC20 {
    ...
    constructor() Ownable(msg.sender) ERC20("Nimbus AI", "NAI") {
        address owner = msg.sender;
        _mint(owner, 1_000_000_000 ether);
        uint256 totalSupplyTokens = totalSupply();

        taxWallet = 0xb85D7820a6e99b0b369028BE1dC02047A6846Ef7;
        devWallet = 0x9562a1Ba9aa7f1e5032a36141D45638B2332800e;
