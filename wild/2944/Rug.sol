...
WHITEPEPE takes the legendary frog spirit to a cleaner, more sophisticated level, blending pure meme power with a fresh aesthetic for the modern crypto world. Step into a bold new chapter of decentralized culture and claim your place in the pack! Join the movement today and help lead the charge as WHITEPEPE leaps toward the moon with the most dedicated community in the space! 🚀:full_moon:

https://whitepepe.live
https://x.com/WhitePepeLive
https://t.me/TheWhitePepeLive
...
contract Token is ERC20, Ownable {
    ...
    uint256 public WHITEPEPESelectCNT = 1;
    uint256 public WHITEPEPEPickCNT = 2;
    uint256 public buyFeeProcent;
    uint256 public sellFeeProcent;
    bool private __isPresaleMEME = true;

    string private _name = "WHITEPEPE";
