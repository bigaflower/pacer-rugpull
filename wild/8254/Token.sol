/**
 ...
 ________  ___  ___  ________  ___  _________   
|\   __  \|\  \|\  \|\   __  \|\  \|\___   ___\ 
\ \  \|\  \ \  \\\  \ \  \|\ /\ \  \|___ \  \_| 
 \ \  \\\  \ \  \\\  \ \   __  \ \  \   \ \  \  
  \ \  \\\  \ \  \\\  \ \  \|\  \ \  \   \ \  \ 
   \ \_____  \ \_______\ \_______\ \__\   \ \__\
    \|___| \__\|_______|\|_______|\|__|    \|__|
          \|__|                                 
                                                
                                                

https://qbit.technology

https://t.me/QubitCompute

https://x.com/QbitCompute
...
contract Token is ERC20, Ownable {
    ...
    {   
        ...
        buyTax.marketingTax = 3000;// 1% = 100
    ...
    function checkLimits(address from, address to, uint256 amount) internal {
        if(limited){
            ...
            if(block.number == launchBlock + 1 || block.number == launchBlock + 2){
                ...
                _txLimits.walletLimit = uint128(totalSupply() * 3 / 1000);
            }
    ...
    function theFuture() public pure returns (string memory) {
