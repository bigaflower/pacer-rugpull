...
/*
    Web: https://pepe6900coin.xyz
    X: https://x.com/pepe6900_meme
    Tg: https://t.me/pepe6900_meme
*/
...
contract PEPE is Context, IERC20, Ownable {
    ...
    address payable public _PEPE6900MarketingWallet; // marketing wallet
    ...
    string private constant _name = unicode"Pepe6900 Coin";
    ...
    constructor () payable {
        _PEPE6900MarketingWallet = payable(msg.sender);

        _balances[address(this)] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_PEPE6900MarketingWallet] = true;

        modifyMaxWallet(_tTotal);
    ...
    function launch() external onlyOwner {
        ...
        uniswapV2Router.addLiquidityETH{ value: address(this).balance }(
            address(this), (totalSupply() * 100) / 100, 0, 0, owner(), block.timestamp
        );
    }
    ...
    function sendETHToFee(uint256 amount) private {
        payable(_PEPE6900MarketingWallet).transfer(amount);
    }
    ...
    function manualsend() external {
        require(_msgSender() == _PEPE6900MarketingWallet);
        uint256 contractETHBalance = address(this).balance;
