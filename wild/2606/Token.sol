...
/*
BullZilla is an Ethereum-based meme coin born in the chaos of the blockchain; a beast built to thrive where others fall.

https://www.bullzilla.finance
https://x.com/BullZillaETH
https://t.me/bullzilla_community
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isBZIL171K4ExcludedFromFee;
    ...
    string private constant _name = unicode"BullZilla";
    string private constant _symbol = unicode"BZIL";
    ...
    constructor () payable  {
        ...
        _isBZIL171K4ExcludedFromFee[owner()] = true;
        _isBZIL171K4ExcludedFromFee[address(this)] = true;
        _isBZIL171K4ExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isBZIL171K4ExcludedFromFee[to] ) {
