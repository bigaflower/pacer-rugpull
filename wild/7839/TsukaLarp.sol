...
It is Larp Season. We build this, we make this the biggest Larp Token ever.
Contract Renouncing, LP BURNT
...
contract TsukaLarp is ERC20, Ownable {
    ...
    constructor() ERC20("Tsuka Larp", "LARPFi") {
        ...
        marketingWallet = address(0x7414117a5e29ab6fF63691c23C4b5F08989C4b0f); // set as marketing wallet
