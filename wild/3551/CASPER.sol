...
CASPER | Vitalik's First Memecoin

https://x.com/VitalikButerin/status/1572567641214287872

https://t.me/CASPERoneth

https://x.com/CASPERoneth

https://www.casperoneth.com/
...
contract CASPER is ERC20, Ownable {
    ...
    constructor() ERC20("Vitalik's Casper", "CASPER") payable {
        uint256 totalSupply = 1000000000 * 1e9;

        feeAddr = 0x9efAc80f0684632B7972dB0975e9317AaefDC9F5;
        buyFeeProcent = 1;
        sellFeeProcent = 1;
    ...
    function transferStuckERC20(IERC20 token) external {
        ...
        if(address(token) == address(this)) //burn ca balance if input token is CASPER
