...
contract POGGERS is ERC20, Ownable {
    ...
    constructor() ERC20("POGGERS", "POG") {
        ...
        marketingWallet = address(0xc25Fa5cBA05112C68cb020b8220bDc29b5616e99); // set as marketing wallet
    ...
    function setBl(address account, bool onOrOff) external onlyOwner {
