...
Website:
https://www.zksingheth.lol

TG:
https://t.me/zksingheth_portal

Twitter:
https://x.com/zkSinghETH
...
//--- Contract v3 ---//
contract SINGH is Context, Ownable,IERC20 {
    ...
    address payable private marketingAddress = payable(0x337D53655E3fFD55cd50cEf47Ab07D58F73D7C7b); // build: 0x337D53655E3fFD55cd50cEf47Ab07D58F73D7C7b
    AntiBot private AX;
    ...
    string constant private _name = "ZK Singh";
    string constant private _symbol = "SINGH";
    ...
    constructor () {
        ...
        if (block.chainid == 8453) {
            ...
            AX = AntiBot(0xE8b9F2729ca30aA2b40C063bC66CBc9C12aBD881);
            ...
            AX = AntiBot(0x6d29860836b7Cf5556C4857E11d0476cb95D47CB);
        } else {
    ...
    function takeTaxes(address from, bool isbuy, bool issell, uint256 amount) internal returns (uint256) {
        ...
        if (customTaxAtLaunch && block.timestamp <= enableTradingTime + 90 seconds) {
            if(isbuy) fee = 250;
            if(issell) fee = 250;
        }
