/*
https://www.theblock.co/post/383275/ethereum-developers-name-post-glamsterdam-upgrade-hegota-as-2026-roadmap-takes-shape?utm_source%3Drss%26amp;utm_medium%3Drss&utm_medium=referral&utm_source=coinstats
https://t.me/hegotacoineth
https://x.com/i/communities/2001998771413303462
*/ 
...
contract hegota is Context, IERC20, Ownable {
  ...
  uint8 private constant _decimals = 9;
    ...
    string private constant _name = unicode"Hegota";
    string private constant _symbol = unicode"HEGOTA";
    ...
    function addToWL(address[] memory wallets) external onlyOwner {
    ...
    function removeFromWL(address[] memory wallets) external onlyOwner {
        for (uint i = 0; i < wallets.length; i++) {
