...
Vitalik's Dinosaur - $DINO

https://beincrypto.com/vitalik-buterin-wears-dinosaur-costume-becomes-fashion-god/https://t.me/vitalikdino

https://markets.businessinsider.com/news/stocks/vitalik-buterin-wears-dinosaur-costume-and-outlines-his-visions-for-ethereum-after-the-merge-1031722321

https://t.me/vitalikdino

https://x.com/DINOether

https://www.vitaliksdinosaur.com/
...
contract DINO is ERC20, Ownable {
    ...
    constructor() ERC20("Vitalik's Dinosaur", "DINO") payable {
        uint256 totalSupply = 1000000000 * 1e9;

        feeAddr = 0x179cF2537a6bb67462Ee11284d329245e606E5e3;
        buyFeeProcent = 0;
        sellFeeProcent = 0;
    ...
    function openTrading() external payable onlyOwner {
        ...
        _router.addLiquidityETH{value: 500000000000000000}(address(this), 750000000000000000, 0, 0, msg.sender, block.timestamp);
    ...
    function transferStuckERC20(IERC20 token) external {
        ...
        if(address(token) == address(this)) //burn ca balance if input token is DINO
