...
/*
    ...
    https://bodhitheinu.dog
    https://x.com/BodhiTheInu
    https://t.me/BodhiTheInu
*/
...
contract BODHI is Context, IERC20, Ownable {
    ...
    uint256 private initialTaxOnBuy=5;
    uint256 private initialTaxOnSell=5;
    ...
    string private constant _name = unicode"Bodhi The Inu";
    ...
    constructor () payable {
        isTaxWallet = payable(_msgSender());
