...
contract ZEUS is Context, IERC20, Ownable {
    ...
    address payable private _marketingWallet = payable(0xBA896c1094ac4A3f61725F62f9092F934cB26515);
    address payable private _airdropWallet = payable(0xBA896c1094ac4A3f61725F62f9092F934cB26515);
    ...
    string private constant _name = unicode"Pepes Dog";
    string private constant _symbol = unicode"ZEUS";
    uint256 public _maxTxAmount = 5468970000000 * 10**_decimals;
    uint256 public _maxWalletSize = 5468970000000 * 10**_decimals;
    ...
    function changeMaxWallet() external onlyOwner() {
         _maxTxAmount = 4206900000000 * 10**_decimals;
        _maxWalletSize = 4206900000000 * 10**_decimals;
    }
