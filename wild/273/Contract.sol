...
https://nypost.com/2025/04/11/lifestyle/uki-the-adorable-orphan-baby-walrus-from-alaska-settles-into-new-home/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ukiaq";
    string private constant _symbol = unicode"UKIAQ";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot87(address a) public view returns (bool){
      return bots[a];
    }
