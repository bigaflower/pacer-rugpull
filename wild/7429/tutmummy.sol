...
contract Mummy_of_Pharaoh_Tutankhamun_CT_Scan is ERC721AC, BasicRoyalties, Ownable, OwnableBasic {
     string private _baseTokenURI;
    uint256 public publicMintPrice = 0.013 ether;
    uint256 public constant RESERVED = 15;
    uint256 public MAX_SUPPLY = 165;
    ...
    mapping(address => bool) public minter;
     ...
     constructor(address initialOwner, address royaltyReceiver, uint96 royaltyFeeNumerator, address _minter) ERC721AC("Mummy of Pharaoh Tutankhamun (CT Scan)", "Mummy of Pharaoh Tutankhamun (CT Scan)") 
