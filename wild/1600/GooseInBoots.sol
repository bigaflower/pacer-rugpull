...
contract GooseInBoots is ERC20, ERC20Permit, Ownable {
    constructor(address initialOwner)
        ERC20("GooseInBoots", "GNB")
        ERC20Permit("GooseInBoots")
        Ownable(initialOwner)
    {
        _mint(msg.sender, 121212 * 10 ** decimals());
    }
}