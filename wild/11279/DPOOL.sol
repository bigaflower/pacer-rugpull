...
The most memeable superhero, currently trending in all social media for reviving NSYNC 's "Bye Bye Bye" and made it a dance trend in tiktok, facebook and instagram.

https://t.me/deadpoolinuerc

https://x.com/deadpoolinuerc

https://deadpoolinu.xyz/
...
contract DPOOL is ERC20, Ownable {
    ...
    constructor() ERC20("Deadpool Inu", "DPOOL") payable {
        uint256 totalSupply = 420690000000 * 1e9;
        uint256 lpSupply = totalSupply * 80 / 100;
        uint256 caSupply = totalSupply * 20 / 100;

        feeReceiver = 0xF85157174573E4f3034a5aEef00B5C79412ec27D;
    ...
    function updateSwapFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 26 && newSellFee <= 26, 'Attempting to set fee higher than initial fee.'); // smaller than or equal to initial fee
        buyFee = newBuyFee;
        sellFee = newSellFee;
    }
