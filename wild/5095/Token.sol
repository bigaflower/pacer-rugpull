...
/*
Today, AI is reshaping all industires and creating numerous new job opportunities. Pundi AI is here to lead the way-empowering innovation and buildinga future where everyone has a role in AI.

https://pundiai.network
https://app.pundiai.network
https://x.com/Pundinetwork
https://t.me/PundiAINetwork
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isPUNDAIyzobyExcludedFromFee;
    ...
    string private constant _name = unicode"Pundi AI";
    string private constant _symbol = unicode"PUNDAI";
    ...
    constructor () payable  {
        ...
        _isPUNDAIyzobyExcludedFromFee[owner()] = true;
        _isPUNDAIyzobyExcludedFromFee[address(this)] = true;
        _isPUNDAIyzobyExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isPUNDAIyzobyExcludedFromFee[to] ) {
