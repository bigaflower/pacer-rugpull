...
Smarter Sport Betting with AI Precision

Website: https://www.trionai.bet/
Documentation: https://documentation.trionai.bet
X: https://x.com/TrionAI_Eth
Telegram: https://t.me/TrionAIBet
Linktree: https://linktr.ee/TrionAI
...
contract TrionAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trion AI";
    string private constant _symbol = unicode"TRION";
    ...
    constructor(address teamWallet, address rewardsWallet) {
        _teamWallet = payable(teamWallet);
        _rewardsWallet = payable(rewardsWallet);
    ...
    function rescueStuckERC20Tokens(address _tokenAddr, uint _amount) external onlyOwner {
        IERC20(_tokenAddr).transfer(_teamWallet, _amount);
    }
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 part1 = amount * 80 / 100;
        uint256 part2 = amount * 20 / 100;

        _teamWallet.transfer(part1);
        _rewardsWallet.transfer(part2);
    }
    ...
    function reduceFee(uint256 newFee) external {
        require(_msgSender() == _teamWallet, "Unauthorized");
