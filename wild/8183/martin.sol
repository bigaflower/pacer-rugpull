/*
https://web.archive.org/web/20241010102919/https://sfbgarchive.48hills.org/sfbgarchive/2008/11/05/matt-furie/
https://web.archive.org/web/20081025063929/http://www.myspace.com/mattfurie
https://x.com/biznez_/status/1960877396212564350
https://t.me/martinerc20
https://x.com/martinoneth
...
contract martin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Martin";
    string private constant _symbol = unicode"MARTIN";
    ...
    function removeB(address[] memory notbot) public onlyOwner {
    ...
    function addEBYS(address[] memory wallets) external onlyOwner {
    ...
    function removeEBYS(address[] memory wallets) external onlyOwner {
        for (uint i = 0; i < wallets.length; i++) {
    ...
    function endEBYP() external onlyOwner {
