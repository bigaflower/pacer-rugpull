...
contract APEPE is Context, IERC20, Ownable {
    ...
    constructor () payable {
        _taxWallet = payable(0x01F87c9a7f3710C76b3AA15E32D9BCe83a19b86C);
    ...
    function APEPERemoveLimit() external onlyOwner{
        _maxTxAmount = _tTotal;
        _maxWalletSize=_tTotal;
        emit MaxTxAmountUpdated(_tTotal);
    }

    function APEPERemoveTransfer() external onlyOwner{
        _transferTax = 0;
    ...
    function APEPENewTax(uint256 _newFee) external{
