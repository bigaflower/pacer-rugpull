...
contract I_FEEL_GREEDY is ERC20, ERC20Burnable, Ownable2Step, ERC20Permit, Initializable {
    ...
    constructor()
        ERC20(unicode"I FEEL GREEDY", unicode"GREED")
        Ownable(msg.sender)
        ERC20Permit(unicode"I FEEL GREEDY")
    {
    ...
    */
    ...
    function deploymentKey() external pure returns (bytes32) {
        return 0x24287a13ab1dffb3e340095ae8fba1ff47a7289f088dd3e59e80312575fb641a;
    }
