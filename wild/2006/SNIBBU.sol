...
contract SNIBBU is Context, IERC20, Ownable {
    ...
    constructor(){
        _devWallet = payable(0x0F424FF98647574D9b0722c1c5a6D13A69E1D573);
    ...
    function addLPUniswap() external onlyOwner() {
        ...
        uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)),0,0,0x0F424FF98647574D9b0722c1c5a6D13A69E1D573,block.timestamp);
        IERC20(uniswapV2Pair).approve(address(uniswapV2Router), type(uint).max);
    }


    function modifyMaxWallet() external onlyOwner() {
         _maxTxAmount = 6666666 * 10**_decimals;
        _maxWalletSize = 6666666 * 10**_decimals;
    }
