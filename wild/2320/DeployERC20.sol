...
contract DeployERC20 is ERC20, BlackList, ERC20Burnable {
    uint8 private _decimals;

    constructor(string memory name, string memory symbol, uint8 decimals_) ERC20(name, symbol) BlackList() ERC20Burnable(){
        _decimals = decimals_;
    }
