...
contract The_Last_Supper_post_restoration is ERC721AC, BasicRoyalties, Ownable, OwnableBasic {
     string private _baseTokenURI;
    uint256 public publicMintPrice = 0.028 ether;
    uint256 public constant RESERVED = 15;
    uint256 public MAX_SUPPLY = 185;
    ...
    mapping(address => bool) public minter;
     ...
     constructor(address initialOwner, address royaltyReceiver, uint96 royaltyFeeNumerator, address _minter) ERC721AC("The Last Supper (post restoration)", "The Last Supper (post restoration)") 
