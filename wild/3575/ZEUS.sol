...
contract ZEUS is Context, IERC20, Ownable {
    ...
    address payable private _marketingWallet = payable(0x30fc4f8338f9637dBEc98E217BBA783529d7a295);
    ...
    function setTaxes(uint256 newFeeOnBuy, uint256 newFeeOnSell) public onlyOwner {
        _buyTax = newFeeOnBuy;
