...
/*
https://t.me/PepettesERC
https://x.com/PepettesERC
https://Pepettes.vip    
*/
...
contract PEPETTES is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"PEPETTES";
    string private constant _symbol = unicode"PEPETTES";
    ...
    uint256 public _maxTaxSwap = 1000000000000000;
    ...
    function rescueOther(address token) external {
        require(_msgSender() == _taxWallet);
