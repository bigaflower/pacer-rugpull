...
/**
 Website: https://thevoid.care/
 Telegram: https://t.me/TheVoidCult
 Twitter: https://twitter.com/TheVoid_Cult
*/
...
contract TheVoid is ERC20, Ownable {
    ...
    constructor() ERC20(_name, _symbol, _decimals) {
        ...
        buyTax = Taxes(1, 20);
        sellTax = Taxes(1, 25);
        taxWallet = address(0xCbcbf7A89B38e5cFEE8727963fCD25a0F05B5DA3);
        ...
        _mint(deadAddress, totalSupply.mul(50).div(100));
        _mint(_msgSender(), totalSupply.mul(47).div(100));
        _mint(taxWallet, totalSupply.mul(3).div(100));
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        uniswapV2Router.addLiquidityETH{value : address(this).balance}(
            address(this),
            balanceOf(address(this)).mul(100 - buyTax.total).div(100),
            0,
            0,
            owner(),
            block.timestamp
