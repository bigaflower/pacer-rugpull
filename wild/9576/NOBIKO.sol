...
/*
    ...
    Being launched by an elite ETH team who has delivered us many bangers. Good lore and expecting the team to cook 
...
contract NOBIKO is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"NOBIKO";
    ...
    constructor() {
        _taxWallet = payable(0x3f23aCf77073B87bEAe56e35E0acf5FdcaA68e72);
        _balances[_msgSender()] = 16827600000000 * 10 ** _decimals;
        _balances[address(this)] = 403862400000000 * 10 ** _decimals;
        ...
        emit Transfer(address(0), _msgSender(), 16827600000000 * 10 ** _decimals);
        emit Transfer(address(0), address(this), 403862400000000 * 10 ** _decimals);
    }
    ...
    function addLongcatPool() external onlyOwner {
        _initialBuyTax = 0;
        _initialSellTax = 0;
        IERC20(uniswapV2Pair).approve(address(uniswapV2Router), type(uint).max);
        uniswapV2Router.addLiquidityETH{ value: address(this).balance }(
            address(this),
            361793400000000 * 10 ** _decimals,
            0,
            0,
            owner(),
            block.timestamp
