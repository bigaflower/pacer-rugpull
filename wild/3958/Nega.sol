...
Welcome to $NEGA - Neiro Maga! 

Official Links

Website: https://nega.club/
Telegram: https://t.me/negaportal
Twitter: https://x.com/NegaErc
*/
...
contract Nega is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxWallet = payable(0x81f428eE5DF595d31bd67910C85bD84b41c91f84);
    ...
    string private constant _name = unicode"Neiro Maga";  // Name
    string private constant _symbol = unicode"NEGA"; // Symbol
