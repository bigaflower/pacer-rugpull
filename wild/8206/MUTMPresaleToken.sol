...
// File: @openzeppelin/contracts/token/ERC20/extensions/MUTMPresale.sol
...
interface MUTMPresale is IERC20 {
...
contract ERC20 is Context, IERC20, MUTMPresale {
...
contract MUTMPresaleToken is ERC20 {
    ...
    string public MUTMPresaleVC = "0.8.26"; 
    
    function getMUTMPresaleVC() public view returns (string memory) {
        return MUTMPresaleVC;
    }
