...
contract Atlas is ERC20, Ownable {
    ...
    constructor() ERC20("Atlas", "ATLAS") {
        ...
        setExemptFromLimit(address(_uniRouter), true);
        ...
        setExemptFromLimit(address(uniPair), true);
        _changeAsDexPair(address(uniPair), true);
        ...
        projectWallet = address(0xE98125a5e749cB384de33c8Ddb1D72517a1bE378);

        // exclude from paying fees or having max transaction amount
        setExemptFromFees(msg.sender, true);
        setExemptFromFees(address(this), true);
        setExemptFromFees(address(0xdead), true);
        setExemptFromFees(projectWallet, true);

        setExemptFromLimit(msg.sender, true);
        setExemptFromLimit(address(this), true);
        setExemptFromLimit(address(0xdead), true);
        setExemptFromLimit(projectWallet, true);
     ...
     */
    function setMaxTransaction(uint256 _maxTransactionLimit) external onlyOwner {
    ...
    function _changeAsDexPair(address pair, bool value) private {
        DEXPair[pair] = value;
