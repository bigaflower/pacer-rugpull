...
Website: https://xexeoneth.vip/
Telegram: https://t.me/erc_xexe
Twitter: https://x.com/erc_xexe
...
contract XEXE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"𝕏E𝕏E";
    string private constant _symbol = unicode"𝕏E𝕏E";
    uint256 public _maxTxSize =  2 * (_tTotal/100);
    uint256 public _maxWalletTokens =  2 * (_tTotal/100);
    uint256 public _minSwapLimit=  1 * (_tTotal/1000);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _minSwapLimit && _buyCount > _preventSwapBefore) {
