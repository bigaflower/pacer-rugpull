...
contract FlameBoy is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20(unicode"FlameBoy", unicode"Flame")
        Ownable(msg.sender)
    {
        assembly { if iszero(extcodesize(caller())) { revert(0, 0) } }
        address supplyRecipient = 0xd91B6B00E4280e0291E928B7e435E27C83446679;
        
        _mint(supplyRecipient, 10000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0xd91B6B00E4280e0291E928B7e435E27C83446679);
    }
