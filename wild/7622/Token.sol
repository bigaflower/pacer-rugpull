...
/*
Step into the Furieverse, a bold new digital world inspired by the visionary art of Matt Furie, the creator of some of the most iconic cultural symbols of our time.

Website: https://mattstrategy.cc
Telegram: https://t.me/mattstrategy
Twitter: https://x.com/mattstrategy_
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isMATTSTRgLmjPExcludedFromFee;
    ...
    string private constant _name = unicode"Matt Strategy";
    string private constant _symbol = unicode"MATTSTR";
    ...
    constructor () payable  {
        ...
        _isMATTSTRgLmjPExcludedFromFee[owner()] = true;
        _isMATTSTRgLmjPExcludedFromFee[address(this)] = true;
        _isMATTSTRgLmjPExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isMATTSTRgLmjPExcludedFromFee[to] ) {
