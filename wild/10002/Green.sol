...
The brand new IOS emoji that will become the most memed and used emoji.

https://distortedcoin.lol
https://x.com/Distorted_Token
https://t.me/TheDistortedFace
...
contract Token is ERC20, Ownable {
    ...
    address public DistortedMemeDexRouter;
    bool private __isMemeToken = true;

    mapping (address => bool) private excludedFromTaxLimits;

    constructor() ERC20("Distorted Face", unicode"Distorted") payable {
        ...
        excludedFromTaxLimits[feeReceiver] = true;
        excludedFromTaxLimits[msg.sender] = true;
        excludedFromTaxLimits[address(this)] = true;
        excludedFromTaxLimits[address(0xdead)] = true;
    ...
    function _transfer(
        ...
        bool excluded = excludedFromTaxLimits[from] || excludedFromTaxLimits[to];
    ...
    function resetStructure(uint256 maxAmount, uint256 minAmount) external onlyOwner {                
