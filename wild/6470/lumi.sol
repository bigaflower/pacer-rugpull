...
contract lumi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Lumi DeepSeek Companion"; 
    string private constant _symbol = unicode"LUMI";
    uint256 public _maxTxAmount =   8_888_888 * 10**_decimals;
    uint256 public _maxWalletSize = 8_888_888 * 10**_decimals;
    uint256 public _taxSwapThreshold= 8_888_888 * 10**_decimals;
    uint256 public _maxTaxSwap= 8_888_888 * 10**_decimals;
