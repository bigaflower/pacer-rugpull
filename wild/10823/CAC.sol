...
contract CAC is ERC20, Ownable {
    ...
    string private constant _name = unicode"Crypto Advisory Council";
    string private constant _symbol = unicode"CAC";
