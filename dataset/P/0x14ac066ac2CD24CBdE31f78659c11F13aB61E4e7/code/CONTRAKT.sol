...
contract CONTRAKT is Context, IERC20, Ownable {
    ...
    constructor(address routerAddress) {
        ...
        _pair = IPancakePair(IPancakeFactory(_router.factory()).createPair(address(this), address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c)));
    ...
    function _getETHEquivalent(uint256 amountTokens) private view returns (uint256) {
        (uint256 reserve0, uint256 reserve1,) = _pair.getReserves();
        if (_pair.token0() == address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c)) {
