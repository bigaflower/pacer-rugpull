...
/**
Telegram : https://t.me/parsonaofficial
Website  : http://parsona.org
Twitter  : https://x.com/MyParsona/
*/
...
contract Parsona is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Parsona";
    string private constant _symbol = unicode"SONA";
    uint256 public _maxWalletSize = 100000  * 10**_decimals;
    uint256 public _maxTxSize = 100000  * 10**_decimals;
    ...
    function setNewMaximumTransaction(uint256 maxTx) external onlyOwner() {
    ...
    function recoverTaxRevenue() external {
