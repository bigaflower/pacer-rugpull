/*
Virtu Network rebranded from VirtuCloud!

VirtuNetwork simplifies access to advanced computing resources, offering
complete control over high-performance GPUs and TPUs.

Web: https://www.virtunetwork.ai/
Telegram: https://t.me/VirtuNetworks
Twitter/X: https://x.com/VirtuNetwork
...
contract VirtuNetwork is ERC20, ERC20Burnable, Ownable2Step {
    ...
    constructor()
        ERC20(unicode"Virtu Network", unicode"VIRTU")
    {
        address supplyRecipient = 0x1461f4993C375D5C884137c7400b60F0f17d5256;

        updateSwapThreshold(50);

        taxwalletAddressSetup(0x4Ca2ABEC83F9F9fcF1869c2BAC721843e83c7194);
        taxwalletFeesSetup(1500, 1500, 0);
        ...
        _transferOwnership(0x1461f4993C375D5C884137c7400b60F0f17d5256);
    }
