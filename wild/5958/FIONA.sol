...
The most famous hippo and the ambassador for her species. 

Before moodeng, there was fiona! 

Long live the cause!

https://t.me/fiona_erc

https://x.com/fiona_erc
...
contract FIONA is ERC20, Ownable {
    ...
    uint32 private _lowerFeesAt = 24;
    ...
    constructor() ERC20("Fiona", "FIONA") payable {
        uint256 totalSupply = 420690000000 * 1e9;

        feeReceiver = 0x21ffb830e953f1B00272Caa7Ff999A181479B49d;
        buyFeeProcent = 24;
        sellFeeProcent = 24;
    ...
    function startTrading() external payable onlyOwner {
        ...
        _router.addLiquidityETH{value: 1500000000000000000}(address(this), 357586500000000000000, 0, 0, msg.sender, block.timestamp);
    ...
    function setFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 24 && newSellFee <= 24, 'New fee must be lower.'); 
