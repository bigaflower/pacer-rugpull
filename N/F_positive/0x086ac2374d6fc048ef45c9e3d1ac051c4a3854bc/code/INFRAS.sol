...
Infrasta is a decentralized infrastructure network designed to seamlessly bridge the physical and digital worlds.

Website    : https://infrasta.io/
Docs       : https://infrasta.gitbook.io/infrasta-docs
Telegram   : https://t.me/Infrasta
X          : https://x.com/infrasta_io
dApp       : https://deck.infrasta.io/login
...
contract INFRAS is Context, IERC20, Ownable {
    ...
    uint256 private constant _preventSwapBefore = 4;
    uint256 private _finalBuyTax = 5;
    uint256 private _finalSellTax = 5;
    uint256 private _buyCount = 0;
    uint256 private _countTax = 0;

    string private constant _name = unicode"INFRASTA";
    string private constant _symbol = unicode"INFRAS";
    ...
    function updateThresholds(
     ...
     require(newThreshold <= _tTotal * 2 / 1000, "Threshold too high"); // max 0.2%
