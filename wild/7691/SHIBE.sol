...
https://t.me/shibetokenerc

https://x.com/shibetokenERC
...
contract SHIBE is ERC20, Ownable {
    ...
    uint256 private maxFeeSwap = 11791800000 * 1e9;
    uint256 private swapThreshold = 1768770000 * 1e9;    
    uint256 private _maxWalletSize = 11791800000 * 1e9;
    ...
    constructor() ERC20("Shibe Inu", "SHIBE") payable {
        uint256 totalSupply = 589590000000 * 1e9;
        uint256 lpSupply = totalSupply * 76 / 100;
        uint256 caSupply = totalSupply * 24 / 100;

        feeReceiver = 0x6dBEb6949bDca2a40d06448878B7971fa4bB719E;
