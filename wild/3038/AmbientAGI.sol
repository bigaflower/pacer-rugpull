/*
    Website : https://AmbientAGI.ai
    X       : https://x.com/AmbientAGI_AI
    TG      : https://t.me/AmbientAGI
...
contract AmbientAGI is Ownable, ERC20 {
    ...
    uint256 public constant MAX_TOTAL_FEE = 30;
    ...
    constructor() Ownable(msg.sender) ERC20("Ambient AGI", "AGI") {
        address owner = msg.sender;
        _mint(owner, 1_000_000_000 ether);
        uint256 totalSupplyTokens = totalSupply();

        operationsWallet = 0x795B661A6Da17E0b03eAA88234dd3bC3534DB1e7;
        devWallet = 0x795B661A6Da17E0b03eAA88234dd3bC3534DB1e7;
        ...
        ExcludeFromLimits(operationsWallet, true);
    ...
    function _updateoperationsWallet(address _operationsWallet) external onlyOwner {
        require(_operationsWallet != ZERO_ADDRESS, InvalidAddress());
    ...
    function _swapTokens(uint256 tokenAmount) internal virtual lockSwapProcess {
        ...
        (success, ) = address(operationsWallet).call{value: ethForRevenue}("");
