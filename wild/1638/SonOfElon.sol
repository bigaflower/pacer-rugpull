...
https://twitter.com/SonOfElonETH
https://t.me/sonofelonETH
...
contract SonOfElon is ERC20, Ownable {
    ...
    string _name = "Son Of Elon";
    string _symbol = unicode"X Æ A-12";
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        treasuryWallet = address(0xD4A6E337A2a46FAddf98f2517a026Cd317174913);
    ...
    function addLiquidityPool() external onlyOwner{
