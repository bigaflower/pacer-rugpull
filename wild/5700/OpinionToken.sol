...
// File contracts/OpinionToken.sol
...
/// @title OpinionToken
/// @notice Omnichain fungible token for cross-chain transfers
/// @dev Inherits LayerZero OFT for cross-chain functionality
contract OpinionToken is OFT {
    constructor(
        string memory _name,
        string memory _symbol,
        address _lzEndpoint,
