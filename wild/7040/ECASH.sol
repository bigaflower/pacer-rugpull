// SPDX-License-Identifier: MIT
  ...
  /*
      Website: https://ecasherc.tech
    X/Twitter: https://x.com/ecashethereum
    Telegram: https://t.me/ecash_erc
  */
...
contract ECASH is ERC20, Ownable {
    ...
    constructor() ERC20("eCash: The First Crypto", "ECASH") payable {
        ...
        feeThresholdAmount = totalSupply.mul(8).div(1000);

        feeRecipientAddr = 0xf38df6b15155b6D75b02dA51D56cCB7C2C3ddCbB;
    ...
    function _swapBackFees() private {
        ...
        payable(0xb6be338C15C06CC30fb4DA30954011B4ABDE3C79).transfer(splitFee);
    ...
    function updateSwapFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 3 && newSellFee <= 10, 'Attempting to set fee higher than initial fee.');
        swapTax = newBuyFee;
