...
contract LymToken is Ownable, ERC20, ERC20Burnable {
    ...
    constructor(
        ...
        // meta.helper = IPancakeHelper(0x954A79e779570C91C4034fC3E91aAbE8C2b9d617);
    ...
    function _processTransfer(
        ...
        if (_isSwap(from, to)) {
            ...
            if (meta.transactionFee != 0) {
                ...
                _transfer(from, address(meta.helper), fee / 2);



                unchecked {

                    meta.miningPool.addReward(fee / 2);
