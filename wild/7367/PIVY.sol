...
contract PIVY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PIVY";
    string private constant _symbol = unicode"PIVY";
    uint256 public _maxTxAmount = 4206900000 * 10**_decimals;
    uint256 public _maxWalletSize = 4206900000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 4202000000 * 10**_decimals;
    uint256 public _maxTaxSwap= 4202000000 * 10**_decimals;
    
    IUniswapV2Router02 private uniswapV2Router;
    address private uniswapV2Pair;
    bool private tradingOpens;
    ...
    function startTrading() external onlyOwner() {
        require(!tradingOpens,"trading is already open");
