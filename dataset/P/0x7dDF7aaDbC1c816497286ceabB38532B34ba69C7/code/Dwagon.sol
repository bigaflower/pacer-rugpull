/*
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .-----------------.
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  ________    | || | _____  _____ | || |      __      | || |    ______    | || |     ____     | || | ____  _____  | |
| | |_   ___ `.  | || ||_   _||_   _|| || |     /  \     | || |  .' ___  |   | || |   .'    `.   | || ||_   \|_   _| | |
| |   | |   `. \ | || |  | | /\ | |  | || |    / /\ \    | || | / .'   \_|   | || |  /  .--.  \  | || |  |   \ | |   | |
| |   | |    | | | || |  | |/  \| |  | || |   / ____ \   | || | | |    ____  | || |  | |    | |  | || |  | |\ \| |   | |
| |  _| |___.' / | || |  |   /\   |  | || | _/ /    \ \_ | || | \ `.___]  _| | || |  \  `--'  /  | || | _| |_\   |_  | |
| | |________.'  | || |  |__/  \__|  | || ||____|  |____|| || |  `._____.'   | || |   `.____.'   | || ||_____|\____| | |
| |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
*/
...
contract Dwagon is ERC20, Ownable {
    ...
    uint256 public buyMeltingFee = 0;
    ...
    uint256 public sellMeltingFee = 0;
    ...
    constructor() ERC20("Dwagon", "$Dwagon") {
        ...
        marketingWallet = address(0x16F2844DAEC6e21e11e878e9893a6B416F39678e); // set as marketing wallet
        devWallet = address(0x4793E9D79896dc8Fa3c3C799e230Fe0A5Ca2424c); // set as dev wallet
        treasuryWallet = address(0x94478081880354C37F7729e0996165aB29510Ed7);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForMelt = (fees * sellMeltingFee) / sellTotalFees;
            }
            // on buy
                ...
                tokensForMelt = (fees * buyMeltingFee) / buyTotalFees;
            }
