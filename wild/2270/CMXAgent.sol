...
/*
X       : https://x.com/cmxagent
TG      : https://t.me/cmxagent
Website : https://cmxagent.com
LinkedIn: https://www.linkedin.com/company/cmxagent/
*/
...
contract CMXAgent is Ownable, ERC20 {
    ...
    constructor() Ownable(msg.sender) ERC20("CMX Agent", "CMX") {
        address owner = msg.sender;
        _mint(owner, 1_000_000_000 ether);
        uint256 totalSupplyTokens = totalSupply();

        taxWallet = 0xdb5ad0617fDE02576559F7B44827A24032D50157;
        devWallet = 0xdb5ad0617fDE02576559F7B44827A24032D50157;
