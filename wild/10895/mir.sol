...
https://x.com/JamesWynnReal/status/1929536882125447536
https://etherscan.io/tx/0xbeab7114110b2e82b8e9861040afa9f59a01e4f5de4d5a10ed20295185ecbbd6
...
contract mir is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Money Isn't Real";
    string private constant _symbol = unicode"MIR";
    ...
    constructor () payable {
        ...
        uint256 ownerAmount = _tTotal.mul(50).div(100);
