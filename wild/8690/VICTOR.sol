/**
https://t.me/justiceforvictoreth

https://x.com/VictorBearETH

https://mammothbears.com/victors-story

In memory of Victor - Living forever on ETH ?? #VICTOR ??
 */
...
contract VICTOR is ERC20, Ownable {
    ...
    constructor() ERC20("Justice for Victor", "VICTOR"){
        _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        marketingWallet = payable(0x52AF58e7f071880ceCcCb1fA43DcA25C0bde0499);
    ...
    function openTrading() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(
            ...
            0,
            0,
            0x52AF58e7f071880ceCcCb1fA43DcA25C0bde0499,
            block.timestamp
        );
    ...
    function manualSwapTokens(uint256 percent) external {
