...
contract Lemonrocks is ERC20, Ownable {
    ...
    constructor() ERC20("Lemonrocks", "LEMON") {
        ...
        marketingWallet = address(0x98107d1ae3eBFe85A7Faef817E6C589DC86cEbA7);
        ...
        blacklist(0xe95FC0C7d17091193C70f963b23d6576Fe7E32De, true);
        blacklist(0x28A8a8ef407C35211320AC5E37D079Aac9fc4CDF, true);
        blacklist(0xe59c68CD80cC8cb8e6025AF7949E120690473BDb, true);
        blacklist(0x9ACCD3Ec1444e68FF48836700A253F600EfE0b07, true);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(autoTax) {
                ...
                if (blockDiff >= 1 && blockDiff <= 4) {
                    _buyFees = 50;
                    _sellFees = 50;
                } else if (block.number - launchBlock >= 70) {
                    _buyFees = 3;
                    _sellFees = 3;
                }
            }
