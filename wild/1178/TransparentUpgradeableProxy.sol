...
pragma solidity ^0.8.0 ^0.8.1 ^0.8.19 ^0.8.2;
...
// src/core/interfaces/IProxyFactory.sol
...
// lib/open-zeppelin/access/Ownable.sol
...
// lib/open-zeppelin/proxy/transparent/ProxyAdmin.sol
...
// src/core/ProxyFactory.sol

/**
 * @title Represents a factory of transparent proxies.
 */
contract ProxyFactory is IProxyFactory, OwnableGuarded {
    ...
    function deploy (
        ...
        address proxyOwnerAddr, 
        bytes memory initData
    ) external override nonReentrant onlyOwner returns (address, address) {
