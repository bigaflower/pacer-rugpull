...
contract LEETH is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"LEEthereum"; //
    string private constant _symbol = unicode"LEETH"; //
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner() && to != feeWallet) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _taxSwapThreshold && _buyCount > _preventSwapBefore) {
                ...
                require(sellCount < 4, "Only 4F sells per block!");
    ...
    function rmBots(address[] memory notbot) public onlyOwner {
