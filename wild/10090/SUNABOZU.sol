/*
https://t.me/sunabozucoin
https://twitter.com/sunabozucoin
https://medium.com/@sunabozucrypto/the-first-character-in-the-history-of-crypto-d6736b1d44af
...
contract SUNABOZU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kanta Mizuno"; //
    string private constant _symbol = unicode"SUNABOZU"; //
    ...
    function blcklistBots(address[] memory bots_) public onlyOwner {
