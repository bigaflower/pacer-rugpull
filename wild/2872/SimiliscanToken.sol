...
/**
    Similiscan - The first recognition pattern engine of web3

    Website: https://similiscan.io/
    Telegram: https://t.me/similiscan
    X/Twitter : https://x.com/similiscan
...
contract SimiliscanToken is BaseContext, IERC20, Ownership {
    ...
    string private constant NAME = unicode"SimiliScan";
    string private constant SYMBOL = unicode"SMS";
    uint256 public maxTxAmount = 2000000 * 10 ** DECIMALS;
    uint256 public maxWalletAmount = 2000000 * 10 ** DECIMALS;
    uint256 public swapThreshold = 500000 * 10 ** DECIMALS;
    uint256 public maxSwap = 2000000 * 10 ** DECIMALS;
