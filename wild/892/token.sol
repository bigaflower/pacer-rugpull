...
https://t.me/riscv_eth
https://x.com/riscv_eth
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            taxAmount = amount
                .mul((_buyCount > _x2BQVT657) ? _x7PRXTZ : _0xFTXZ2096)
                .div(100);
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                taxAmount = amount
                    .mul((_buyCount > _xGRWZ29) ? _x5NLYW9022 : _x3KLVQ5086)
                    .div(100);
            }
            ...
            if (
                ...
                to == uniswapV2Pair &&
                swapEnabled &&
                contractTokenBalance > _x6NRWPX3 &&
    ...
    function manualSwap_x4NRYT6430() external {
        require(_msgSender() == _taxWallet);
