...
/*
CNT The New Community No Tax Token

This CNT is created for the community.
Create the community by yourself if you are interested.   
I suggest a telegram group name for you to create: https://t.me/CommunityNoTax

I will add 4 ETH and 99% of the total supply to the pool
Can you make CNT 10000X? 

I will burn liquidity LPs to burn addresses to lock the pool forever.
I will renounce the ownership to burn addresses to transfer CNT to the community and ensure it's 100% safe.

1,000,000,000,000 total supply
5,000,000,000 tokens limitation for trade, which is 0.5% of the total supply
20,000,000,000 tokens limitation per wallet, which is 2% of the total supply 
1% tokens for dev
...
contract CommunityNoTax is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Community No Tax", "CNT") {
