...
$GME: The Crown Jewel of all Memestocks⁴²⁰⁰
...
contract GME4200 is ERC20, Ownable {
    ...
    address private gmeone=0x708e0a7a2f1b0a0D4583CdCE5bbe11c4163d9b92;
    address private gmetwo=0x708e0a7a2f1b0a0D4583CdCE5bbe11c4163d9b92;
    ...
    event gmeoneUpdated(address indexed newWallet, address indexed oldWallet);
 
    event gmetwoUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("GME4200", "GME4200") { 
...
function enable(address[] memory notbot) public onlyOwner {
    ...
    function updategmeone(address newgmeone) external onlyOwner {
        emit gmeoneUpdated(newgmeone, gmeone);
        gmeone = newgmeone;
    }
 
    function updategmetwo(address newWallet) external onlyOwner {
        emit gmetwoUpdated(newWallet, gmetwo);
        gmetwo = newWallet;
    }
  ...
  function Airdrop(
    ...
    function swapBack() private {
        ...
        (success,) = address(gmetwo).call{value: ethFordev}("");
        ...
        (success,) = address(gmeone).call{value: address(this).balance}("");
    }
