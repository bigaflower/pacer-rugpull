...
contract TETHER is ERC20, ERC20Burnable, Ownable2Step, Initializable {
        ...
        Ownable(msg.sender)
    {
        ...
        address supplyRecipient = 0x02BBbDceb71F63a5936AffD68Fd962dd47E6729f;
        
        _mint(supplyRecipient, 10000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x02BBbDceb71F63a5936AffD68Fd962dd47E6729f);
    }
    ...
    */
    ...
    function deploymentKey() external pure returns (bytes32) {
        return 0xdf8e32188be6668ea635595dc31eee6017a19c4b6b7c53c567803d438b32c4fc;
    }
