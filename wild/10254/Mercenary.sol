...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.3/contracts/token/ERC20/extensions/ERC20Capped.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.3/contracts/token/ERC20/extensions/ERC20Pausable.sol
...
/// @title Mercenary Token (HSN)
/// @notice Secure, capped, pausable, and burnable ERC-20 token
contract Mercenary is ERC20Burnable, ERC20Capped, ERC20Pausable, Ownable {
    constructor()
        ERC20("Mercenary", "HSN")
    ...
    receive() external payable {
        revert("Mercenary: ETH not accepted");
    }

    fallback() external payable {
        revert("Mercenary: fallback not allowed");
    }
}