...
The happiest dino mascot, $OGGY.

https://www.oggyfriend.fun
https://x.com/Oggy_friend
https://t.me/Oggy_friend
...
contract OGGY is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isOggyExcludedFromFee;
    ...
    constructor() payable {
        ...
        _isOggyExcludedFromFee[owner()] = true;
        _isOggyExcludedFromFee[address(this)] = true;
        _isOggyExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && !_isOggyExcludedFromFee[to]) {
