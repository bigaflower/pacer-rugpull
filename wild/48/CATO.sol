...
Website: https://catothecateth.com/

Telegram: https://t.me/CatoTheCatEth

X: https://x.com/CatoTheCatcoin
...
contract CATO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Cato The Cat";
    string private constant _symbol = unicode"CATO";
    ...
    constructor () {
        _taxWallet = payable(0x82FE0dE8cEa10B628BA31C9A82850d04A59C6Ce5);
