...
contract Catsby is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 888444888444 * 10**_decimals;
    string private constant _name = unicode"Catsby";
    string private constant _symbol = unicode"CATSBY";
    uint256 public _maxTxAmount =   17768897768 * 10**_decimals;
    uint256 public _maxWalletSize = 17768897768 * 10**_decimals;
    uint256 public _taxSwapThreshold= 8884448884 * 10**_decimals;
    uint256 public _maxTaxSwap= 8884448884 * 10**_decimals;

    IUniswapV2Router02 private uniswapV2Router;
    address public uniswapV2Pair;
    bool private tradingOpen;
    uint256 private sellsPerBlock = 3;
    uint256 private buysFirstBlock = 25;
