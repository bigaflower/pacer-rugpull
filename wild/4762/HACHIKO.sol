...
/*
    ...
    Hachiko is the memecoin inspired by the legendary Akita who waited every single day at Shibuya Station for his owner- even after he passed.

    https://www.hachikoinu.fun
    https://x.com/Hachiko_Inu_Eth
    https://t.me/Hachiko_Inu_Eth
*/
...
contract HACHIKO is Context, IERC20, Ownable {
    ...
    uint256 public _tokenHYPEREG40v = 1;
    string public _tokenName = unicode"Hachiko Inu";
    ...
    function swapHYPEREG40vTokensForEth(uint256 tokenAmount) private lockTheSwaps {
    ...
    function manualHYPEREG40vSwap() external {
        ...
        if(ethBalance>0){
            ...
            swapHYPEREG40vTokensForEth(tokenBalances);  
    }
}