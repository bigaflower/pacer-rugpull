...
contract SOL is ERC20, Ownable {
    ...
    constructor() ERC20("Sons Of Liberty", "SOL") {
		...
		charityWallet = address(0x73078218ade7b2DD5C704e37A167AD45d86264B8); // set as charity wallet
        marketingWallet = address(0x73078218ade7b2DD5C704e37A167AD45d86264B8); // set as marketing wallet
        devWallet = address(0x73078218ade7b2DD5C704e37A167AD45d86264B8); // set as dev wallet
