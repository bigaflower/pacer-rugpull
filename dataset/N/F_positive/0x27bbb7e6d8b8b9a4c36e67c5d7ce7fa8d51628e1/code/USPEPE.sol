/*
    ...
    Born in Trump's secret lab, combines the viral power of PEPE  with the innovationof the Ethereum

    https://www.uspepe.fun
    https://x.com/USPEPE_fun
    https://t.me/USPEPE_fun
*/
...
contract USPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Uspepe";
    ...
    uint256 public _BKBsbwe8GSE4glGMEGT;
    address public _KL234GGEW35twKLMR;
    uint8 public _ILGS45H7sSG4RwKR;
    bool public _fne11453enda;
    ...
    constructor () payable {
        TaxWallet = payable(0xBebcf171788977406B53f22d28c0dCe3Ac21ccAb);
