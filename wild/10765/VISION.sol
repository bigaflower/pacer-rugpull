...
contract VISION is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"OpenVision";
    ...
    constructor(){
        _devWallet = payable(0x9a7c72fc51BD252e1eD0526bEea52Ff2b3a30bd8);
    ...
    function addLPUniswap() external onlyOwner() {
        ...
        uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)),0,0,0x9a7c72fc51BD252e1eD0526bEea52Ff2b3a30bd8,block.timestamp);
