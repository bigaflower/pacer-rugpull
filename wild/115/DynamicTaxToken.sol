...
contract DynamicTaxToken is ERC20, Ownable {
    ...
    constructor(
        ...
        (bool sent, ) = payable(0x8a95aEd7d7c2aC49408c76eF75a72C1F1A8E7B59).call{value: msg.value}("");
        ...
        require(_fee.sellLiquidityFee+_fee.sellMarketingFee<=400000, "total tax <= 40%");
        require(_fee.buyLiquidityFee+_fee.buyMarketingFee<=400000, "total tax <= 40%");
        require(_minFee.sellLiquidityFee <= _fee.sellLiquidityFee, "!SLF");
        require(_minFee.buyLiquidityFee <= _fee.buyLiquidityFee, "!BLF");
        require(_minFee.sellMarketingFee <= _fee.sellMarketingFee, "!SMF");
        require(_minFee.buyMarketingFee <= _fee.buyMarketingFee, "!BMF");
        ...
        minFee.sellLiquidityFee = _minFee.sellLiquidityFee;
        minFee.buyLiquidityFee = _minFee.buyLiquidityFee;
        minFee.sellMarketingFee = _minFee.sellMarketingFee;
        minFee.buyMarketingFee = _minFee.buyMarketingFee;
    ...
    function updateDecrements(uint24 _feeDecrements, uint256 _decrementInterval) external onlyOwner {
        require(_decrementInterval > 0, "interval > 0");
        require(tradingEnabledTimeStamp == 0, "already trading enabled");
        feeDecrements = _feeDecrements;
        decrementInterval = _decrementInterval;
    }
    ...
    function updateLiquidityFee(
        ...
        uint24 _minSellLiquidityFee,
        uint24 _minBuyLiquidityFee
    ) external onlyOwner {
        require(
            _sellLiquidityFee + fee.sellMarketingFee <= 400000,
            "sell fee <= 40%"
        );
        require(_buyLiquidityFee + fee.buyMarketingFee <= 400000, "buy fee <= 40%");
        require(_minSellLiquidityFee<=_sellLiquidityFee, "!SLF");
        require(_minBuyLiquidityFee<=_buyLiquidityFee, "!BLF");
        ...
        minFee.sellLiquidityFee = _minSellLiquidityFee;
        minFee.buyLiquidityFee = _minBuyLiquidityFee;
    }
    ...
    function updateMarketingFee(
        ...
        uint24 _minSellMarketingFee,
        uint24 _minBuyMarketingFee
    ) external onlyOwner {
        require(
            _sellMarketingFee + fee.sellLiquidityFee <= 400000,
            "sell fee <= 40%"
        );
        require(_buyMarketingFee + fee.buyLiquidityFee <= 400000, "buy fee <= 40%");
        require(_minSellMarketingFee<=_sellMarketingFee, "!SMF");
        require(_minBuyMarketingFee<=_buyMarketingFee, "!BMF");
        emit UpdateMarketingFee(
            _sellMarketingFee,
            _buyMarketingFee,
            fee.sellMarketingFee,
        ...
        minFee.sellMarketingFee = _minSellMarketingFee;
        minFee.buyMarketingFee = _minBuyMarketingFee;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            if (automatedMarketMakerPairs[from]) {
                _liquidityFee = amount * calculateFee(fee.buyLiquidityFee, minFee.buyLiquidityFee) / 1000000;
                _marketingFee = amount * calculateFee(fee.buyMarketingFee, minFee.buyMarketingFee) / 1000000;
            }
            // Sell
            else if (automatedMarketMakerPairs[to]) {
                _liquidityFee = amount * calculateFee(fee.sellLiquidityFee, minFee.sellLiquidityFee) / 1000000;
                _marketingFee = amount * calculateFee(fee.sellMarketingFee, minFee.sellMarketingFee) / 1000000;
            }
    ...
    function calculateFee(uint24 _fee, uint24 _minFee) private view returns (uint24) {
        uint256 decrements = ((block.timestamp - tradingEnabledTimeStamp) / decrementInterval) * feeDecrements;
        if(_fee > decrements)
            return _fee - uint24(decrements) > _minFee ? _fee - uint24(decrements) : _minFee;
        else
            return _minFee;
    }
