 ...
 * https://x.com/pepcoinerc
 * https://pepcoinerc.com/
 * https://t.me/pepcoinerc
 */
...
contract PEP is ERC20, Ownable {
    ...
    constructor() ERC20("PEP", "PEP") {
        ...
        marketingReceiver = address(0xFb3df775d134e4961E453125C9e27612d8B80b26);
     ...
     */
    function modTxLimit(uint256 _maxTransactionLimit) external onlyOwner {
     ...
     */
    function modifyAddressLimitExemption(
        address _add,
        bool _excluded
    ) public onlyOwner {
     ...
     */
    function modBuyFeeRate(uint256 _value) external onlyOwner {
        buyTax = _value;
     ...
     * @param _value The fee for the marketing wallet
     */
    function modSellFeeRate(uint256 _value) external onlyOwner {
        sellTax = _value;
        require(
            sellTax <= 100,
    ...
    function modTransferFeeRate(uint256 _value) external onlyOwner {
        transferTax = _value;
        require(
            transferTax <= 100,
    ...
    function swapBack(uint256 amount) private {
        ...
        if (contractBalance > amount * ratio) {
            contractBalance = amount * ratio;
        }
