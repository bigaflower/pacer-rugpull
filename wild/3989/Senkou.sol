/*
Source: https://www.shibapedigree.com/details.php?id=63691&utm_source
Telegram: https://t.me/senkougoeth
X: Https://x.com/senkougoinu
*/ 
...
contract Senkou is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Senkou Go";
    string private constant _symbol = unicode"SENKOU";
    ...
    constructor () payable {
        ...
        uint256 ownerAmount = _tTotal.mul(88).div(100);
