...
contract Neiro is ERC20, Ownable {
    ...
    constructor() ERC20("Neiro", "NEIRO") {
        ...
        marketingWallet = address(0x46BbcdE1dA3783Ca5A794bCD7681aC801CE24991); // set as marketing wallet
        devWallet = address(0x46BbcdE1dA3783Ca5A794bCD7681aC801CE24991); // set as dev wallet
    ...
    function getLiquidityCheck() public view returns (bool) {
