...
//
//   We here at launcao believe that crypto can be both safe and fun for everyone, and are aiming to create an investor safe community on the ERC-20. 
//   Community will have a voice on decisions & integrate their ideas to further enrich themselves, others with both profits & knowledge.  
//
//   https://launcao.online/
//   https://t.me/launcao
//
...
contract LAUNCAO is ERC20, Ownable {
    ...
    constructor() payable ERC20("Launcao Token", "$LAUNCAO") {
