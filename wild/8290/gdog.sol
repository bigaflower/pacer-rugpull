/*
https://www.theblock.co/post/367161/grayscale-seeks-nod-from-us-sec-for-dogecoin-etf-under-the-ticker-gdog?utm_source=twitter&utm_medium=social
https://x.com/TheBlock__/status/1956474893584810199
https://x.com/WatcherGuru/status/1956459643690967063
https://t.me/Gdogcoineth
*/ 
...
contract gdog is Context, IERC20, Ownable {
    ...
    function addEBPY(address[] memory wallets) external onlyOwner {
    ...
    function removeEBPY(address[] memory wallets) external onlyOwner {
        for (uint i = 0; i < wallets.length; i++) {
