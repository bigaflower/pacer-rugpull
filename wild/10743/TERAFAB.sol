...
contract TERAFAB is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Terafab";
    string private constant _symbol = unicode"TERAFAB";
    ...
    constructor () {
        _taxWallet = payable(0x2907FF26A8BEFB678f049389b9aEAe4eBf8E5073);
