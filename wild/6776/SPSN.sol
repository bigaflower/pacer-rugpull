...
contract SPSN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"South Park Sucks Now"; //
    string private constant _symbol = unicode"SPSN"; //
