...
contract STREAMERINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Streamer Inu";
    string private constant _symbol = unicode"STREAMI";
