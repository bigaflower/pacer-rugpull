...
// node_modules/@stake-dao/strategies/src/interfaces/IStrategy.sol
...
// node_modules/@stake-dao/strategies/src/interfaces/IAccountant.sol

interface IAccountant_0 {
    function checkpoint(
        address gauge,
        address from,
        address to,
...
// node_modules/@stake-dao/strategies/src/interfaces/IRewardVault.sol
...
interface IRewardVault is IERC4626 {
    ...
    function ACCOUNTANT() external view returns (IAccountant_0);
...
// src/lending/interfaces/IStrategyWrapper.sol
...
// src/lending/wrappers/StrategyWrapper.sol

interface IAccountant_1 {
...
contract StrategyWrapper is ERC20, IStrategyWrapper, Ownable, ReentrancyGuardTransient {
    ...
    IAccountant_1 internal immutable ACCOUNTANT;
    ...
    constructor(IRewardVault rewardVault, address lendingProtocol, address _owner) ERC20("", "") Ownable(_owner) {
        ...
        IAccountant_1 accountant = IAccountant_1(address(rewardVault.ACCOUNTANT()));
    ...
    function _claim(address account) internal returns (uint256 amount) {
        ...
        IAccountant_1.AccountData memory wrapper = ACCOUNTANT.accounts(address(REWARD_VAULT), address(this));
    ...
    function claimExtraRewards(address receiver) external nonReentrant returns (uint256[] memory amounts) {
        ...
        return _claimExtraRewards(REWARD_VAULT.getRewardTokens(), receiver);
    }
...
// src/lending/wrappers/MorphoStrategyWrapper.sol
