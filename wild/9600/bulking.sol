...
/*
    ...
    Forget the weak gains! $BULKING is for the legends who lift the charts. No more crying, just pure muscular profits

    Website: https://etherbulking.vip
    X: https://x.com/bulking_meme
    TG: https://t.me/bulking_meme
...
contract BULKING is ERC20, Ownable {
    IUniswapV2Router02 private constant _router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

    address public uniswapPair;
    address public immutable feeReceiver;

    uint256 private maxWalletSize = 3205900000 * 1e9;
    uint256 private txMaxSwapFee = 3205900000 * 1e9;
    uint256 private txMinSwapFee = 1039051000 * 1e9; 
    uint32 private _buyCount;
    uint32 private _sellCount;
    uint32 private _lastSellBlock;
    uint256 private _startBlock;
    uint32 private _preventSwapBefore = 35;
    uint32 private _lowerFeesAt = 70;
    ...
    constructor() ERC20(unicode"Ethereum Bulking", unicode"BULKING") payable {
    ...
    function _transfer(
        ...
        if (isSell && !_inSwap && contractTokenBalance >= txMinSwapFee &&
          !excluded && _buyCount > _preventSwapBefore
            ...
            _inSwap = true;
            swapTokensForEth(min(amount, min(contractTokenBalance, txMaxSwapFee)));
            _inSwap = false;
    ...
    function updateSwapFeeAmount(uint256 maxAmount, uint256 minAmount) external onlyOwner {                
        txMaxSwapFee = maxAmount;
        txMinSwapFee = minAmount;
    }
