...
// File: contracts/EarlyRetiredPenguinsClub.sol
...
contract EarlyRetiredPenguinsClub is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  ) ERC721A("Early Retired Penguins Club", "ERPC") {
