...
// 
// Telegram : https://t.me/skyeportal
// Twitter  : https://x.com/Skyeerc20
// Website : https://www.instagram.com/p/DJoZFcHM9IW/?igsh=MWlyNW11eDBtc2llcA==
...
contract SKYE is Context, IERC20, Ownable {
    ...
    uint256 private initialTaxOnBuy=20;
    ...
    string private constant _name = unicode"Skye";
    string private constant _symbol = unicode"SKYE";
    uint256 public maxTxAmt =  2 * (_tTotal/100);
    uint256 public maxSizeOfWallet =  2 * (_tTotal/100);
    ...
    constructor () {
        isTaxWallet = payable(0x9C008e50576017631cADd121Da7E97673ae35615);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _tTaxSwapThreshold && buys_Count > noSwapBefore) {
