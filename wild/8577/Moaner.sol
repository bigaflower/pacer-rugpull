 ...
 * https://x.com/MoanerOnEth
 * https://t.me/MoanerOnEth
 * https://moaner.net
 */
...
contract Moaner is Context, ERC20, Ownable {
    ...
    constructor() ERC20("Moaner by Matt Furie", "MOANER") {
        ...
        _taxWallet = payable(0xC42270A934DD4b225949236C9F944a80c93Fbc13);
    ...
    function changeMarketingWallet(address payable newRcv) external onlyOwner {
        _taxWallet = newRcv;

        emit FeeReceiverUpdated(newRcv);
    }

    function changeMaxTx(uint256 newTxMax) external onlyOwner {
    ...
    function setMaxWallet(uint256 newWalletMax) external onlyOwner {
