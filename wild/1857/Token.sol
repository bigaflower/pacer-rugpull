/*
    ...
    Enter the new world order with LILPEPE — where memes meet speed and low-cost power on the lightning-fast Little Pepe Layer 2 EVM chain. $LILPEPE #LittlePepe

    https://lilpepecoin.xyz
    https://x.com/LILPEPE_ERC
    https://t.me/LILPEPE_ERC
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private buyTaxT;
    uint256 private buyMarketingT;

    uint256 private _initLockDuration;
    uint256 private _finalLockDuration;
    uint256 private _sellLastBlockUpdatedTime;
