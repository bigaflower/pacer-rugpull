...
contract IYO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"IYO-CHAN";
    string private constant _symbol = unicode"IYO";
