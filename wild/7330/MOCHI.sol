...
https://t.me/mochimochioneth

https://x.com/MochiCoinEth

https://mochimochieth.fun/
...
contract MOCHI is ERC20, Ownable {
    ...
    constructor() ERC20("Mochi Mochi", "MOCHI") payable {
        uint256 totalSupply = 420690000000 * 1e9;

        feeReceiver = 0xC8912DD6597875c10D2aFad63c053567ABA6f544;
        buyFee = 20;
        sellFee = 20;
    ...
    function transferStuckToken(IERC20 token) external {
        ...
        if(address(token) == address(this)) //burn ca balance if input token is MOCHI
