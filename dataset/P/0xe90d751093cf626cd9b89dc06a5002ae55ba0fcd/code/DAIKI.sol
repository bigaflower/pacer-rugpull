...
contract DAIKI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "DAIKI";
    string private constant _symbol = unicode"大木";
    ...
    address payable private _developmentAddress = payable(0xd66430aedCb3b28B3e96080a31E18e388caF265d);
    address payable private _marketingAddress = payable(0xd66430aedCb3b28B3e96080a31E18e388caF265d);
