...
// File: @openzeppelin/contracts/token/ERC20/extensions/ZBCN.sol
...
contract ERC20 is Context, IERC20, ZBCN {
...
contract ZBCNToken is ERC20 {
    ...
    string public ZBCNVC = "0.8.26"; 
    
    function getZBCNVC() public view returns (string memory) {
        return ZBCNVC;
    }
