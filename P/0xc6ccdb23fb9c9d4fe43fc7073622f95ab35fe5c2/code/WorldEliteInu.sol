...
contract WorldEliteInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "World Elite Inu";
    string private constant _symbol = unicode"世界精英犬";
    ...
    address payable private _developmentAddress = payable(0x56bA1D7F869bBE8ff983b41230e2B32b23968281); 
    address payable private _marketingAddress = payable(0x56bA1D7F869bBE8ff983b41230e2B32b23968281);
