...
/*
https://t.me/navann_erc
https://x.com/nullumcrypto/status/1920443238818726166?s=61
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _0xFTXZ2090 = 20;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            taxAmount = amount
                .mul((_buyCount > _x2BQVT657) ? _x7PRXTZ : _0xFTXZ2090)
                .div(100);
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                taxAmount = amount
                    .mul((_buyCount > _xGRWZ29) ? _x5NLYW9028 : _x3KLVQ5088)
                    .div(100);
            }
