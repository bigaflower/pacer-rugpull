 ...
 * https://t.me/BTC2EthPortal
 * https://x.com/Bitcoin2CoinETH
 * https://btc2.money/
 */
...
contract BTC2 is ERC20, Ownable {
    ...
    constructor() ERC20("Bitcoin 2.0", "BTC2") {
        IDexRouter _dexRouter = IDexRouter(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        wlLimits(address(_dexRouter), true);
        ...
        marketingWallet = address(0x8A5abB339Da6485E90767B12D0f4E4B7AbcCb31F);

        // exclude from paying fees or having max transaction amount
        wlFess(msg.sender, true);
        wlFess(address(this), true);
        wlFess(address(0xdead), true);
        wlFess(marketingWallet, true);

        wlLimits(msg.sender, true);
        wlLimits(address(this), true);
        wlLimits(address(0xdead), true);
        wlLimits(marketingWallet, true);
     ...
     */
    function wlLimits(address _add, bool _excluded) public onlyOwner {
     ...
     */
    function feesBuySet(uint256 _value) external onlyOwner {
        buyTaxTotal = _value;
     ...
     * @param _value The fee for the marketing wallet
     */
    function feesSellSet(uint256 _value) external onlyOwner {
        sellTaxTotal = _value;
        require(
            sellTaxTotal <= 100,
    ...
    function feesTransferSet(uint256 _value) external onlyOwner {
     ...
     * @param _excluded If the wallet is excluded or not
     */
    function wlFess(address _add, bool _excluded) public onlyOwner {
     ...
     */
    function feeReceiverSt(address _marketing) external onlyOwner {
     ...
     */
    function taxWalletAdress() external view returns (address _marketingWallet) {
