...
/**
 * $BRCG — Bitcoin Roller Coaster Guy
 *
 * Tribute to the first crypto meme ever created (2013).
 * This meme captured the volatility of Bitcoin better than anything else.
 *
 * "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks"
 * — Block 0, Bitcoin Genesis
 * BRCG is the cultural genesis.
 *
 *
 * TG: https://t.me/BRCG_ETH
 * Website: https://btccoaster.com
 * X: https://x.com/brcg_eth
 *
 */
...
contract BRCG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    address payable private _taxWallet;
    string private constant _name = unicode"Bitcoin Roller Coaster Guy";
    string private constant _symbol = unicode"BRCG";

    string public genesisMessage;
    string public satoshiLastRide;
    ...
    constructor() {
        _taxWallet = payable(0x39F4E72d038e82DCAbaE9EF3C7b7c67DaB8E49F3);
        ...
        genesisMessage = unicode"The Times 03/Jan/2009 Chancellor on brink of second bailout for banks";
        satoshiLastRide = unicode"I created the chain. This is the meme that rode it. — Satoshi Nakamoto, July 2025";
