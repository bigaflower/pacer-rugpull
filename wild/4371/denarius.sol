...
contract denarius is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"denarius";
    string private constant _symbol = unicode"DENARIUS";
