/*
Show AI fuses creativity and technology to produce cinematic worlds — powered by the $SHOW Token.
*/
...
contract SHOW is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20(unicode"SHOW", unicode"SHOW")
        Ownable(msg.sender)
    {
        assembly { if iszero(extcodesize(caller())) { revert(0, 0) } }
        address supplyRecipient = 0x15dE960e013c1B455F861CE15072d5C514627F30;
        ...
        _transferOwnership(0x15dE960e013c1B455F861CE15072d5C514627F30);
    }
