...
contract Vitruvian_Man is ERC721AC, BasicRoyalties, Ownable, OwnableBasic {
     string private _baseTokenURI;
    uint256 public publicMintPrice = 0.036 ether;
    uint256 public constant RESERVED = 10;
    uint256 public MAX_SUPPLY = 210;
    ...
    mapping(address => bool) public minter;
     ...
     constructor(address initialOwner, address royaltyReceiver, uint96 royaltyFeeNumerator, address _minter) ERC721AC("Vitruvian Man", "Vitruvian Man") 
