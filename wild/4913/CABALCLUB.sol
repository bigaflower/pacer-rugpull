...
$cabal club - boys club, inverted, cabalised. 

0x69686766

website : https://cabalclub.vip
telegram : https://t.me/cabalclub_eth
twitter: https://x.com/cabalclub_eth
...
contract CABALCLUB is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CABAL CLUB";
    ...
    function rescueCABALTokens(address _tokenAddr, uint _amount) external onlyOwner {
