...
Website: https://sanchan.vip
Telegram: https://t.me/sanchan_erc
Twitter: https://x.com/sanchan_erc
TikTok: https://www.tiktok.com/@kantaro_japanwalker_?_t=ZN-8sq6gtzRLHC&_r=1
...
contract SAN is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapPair && to != address(uniswapV2Router) && ! _isExcludeFromFee[to] ) {
