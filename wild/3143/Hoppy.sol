...
A frog with a glass in hand, always ready for another toast. Welcome to Hoppy.

https://hoppymeme.xyz/
https://t.me/Hoppy_Official
https://x.com/Hoppy_coin_
...
contract Hoppy is ERC20, Ownable {
    ...
    bool private contractSBEnabled = true;
    ...
    constructor() ERC20(unicode"Hoppy", unicode"HOPPY") {
        ...
        maxTransactionLimit = 20000000 * 10**_decimals;
        maxWalletLimit = 20000000 * 10**_decimals;

        triggerSB = 500000 * 10**_decimals;
        limitSB = 20000000 * 10**_decimals;
