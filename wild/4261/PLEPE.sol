/**
 ...
 Website : https://plepe.xyz/
 Telegram : https://t.me/PlepeErc
 Twitter : https://twitter.com/PlepeERC
...
contract PLEPE is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public maxBuyLimit = 840_000 * 10**decimals();
    uint256 public maxSellLimit = 840_000 * 10**decimals();
    uint256 public maxWalletLimit = 840_000 * 10**decimals();

    address public marketingWallet = 0x0288d962Da395659842a50c1409ac394918F53BE;
    ...
    constructor() ERC20("PLEB PEPE", "PLEPE") {
        _tokengeneration(marketingWallet, 42_000_000 * 10**decimals());
    ...
    function RenouncePLEPE() external onlyOwner {
