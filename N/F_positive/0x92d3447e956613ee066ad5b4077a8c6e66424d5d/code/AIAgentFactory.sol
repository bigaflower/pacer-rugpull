/*
    ...
    X       : https://x.com/AIAgentFactoryX
    TG      : https://t.me/aiagentfactory
    Website : https://aiagentfactory.io/
...
contract AIAgentFactory is Ownable, ERC20 {
    ...
    constructor() Ownable(msg.sender) ERC20("AI Agent Factory", "AIAF") {
        address owner = msg.sender;
        _mint(owner, 1_000_000_000 ether);
        uint256 totalSupplyTokens = totalSupply();

        taxWallet = 0xb2b8dd10a671aF3e2b463318c834cF9019c102c9;
        devWallet = 0xb2b8dd10a671aF3e2b463318c834cF9019c102c9;
