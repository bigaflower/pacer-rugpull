...
// 
// https://x.com/sackfurie
// https://t.me/TheOfficialSackFurie
// 

// Sack Furie ($SACKS) is the most unhinged meme coin to hit the blockchain since Pepe first swung onto the scene. Inspired by the deranged chaos of Matt Furie’s universe, this token is pure degenerate meme energy, no utility, no roadmap, just wild vibes and sack-swinging fury. $SACKS is a cultural statement, a movement of unapologetic absurdity and meme-powered momentum. Whether you’re in it for the memes or the madness, Sack Furie is here to slap the market awake.
...
contract SackFurie is ERC20, Ownable {
    ...
    constructor() ERC20("SackFurie", unicode"SACKS") {
        ...
        address _teamWallet = address(0x552594b83058882C2263DBe23235477f63e7D60B);

        maxTransaction = 20000000 * (10 ** decimals());
        maxWallet = 20000000 * (10 ** decimals());
        swapTokensAtAmount = 2000000 * (10 ** decimals());
        ...
        marketingWallet = address(0x87d79e112B93F13e75ACcb60378106d8F0ea87Cb);
