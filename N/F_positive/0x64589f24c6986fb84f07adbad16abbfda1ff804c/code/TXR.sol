 ...
 * Texor.cloud
 * 
 * Build, run and monetize AI agents without coding.
 * Connect AI models, APIs and onchain logic in minutes.
 * 
 * Website: https://texor.cloud
 * Telegram: https://t.me/texorcloud
 * Twitter: https://x.com/texorcloud
 */  
...
contract TXR is ERC20, Ownable {
    ...
    constructor() payable ERC20("Texor.cloud", "TXR") {
        ...
        _createInitialSupply(address(0x577e39AF73D62c1459f1afA3832737b6bD2435dF), (totalSupply * 10) / 100);  
        _createInitialSupply(address(0x4eA49D1b384B782A61d15Ff7AC05667BaC2b7d1c), (totalSupply * 10) / 100); 
    ...
    function prepareLpPair() external onlyOwner {
