...
/*
https://t.me/blockycoinerc
https://x.com/blockycoineth    
*/
...
contract BLOCKY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Blocky Doge";
    string private constant _symbol = unicode"BLOCKY";
    ...
    function reduceTax(uint256 _newFee) external {
        ...
        require(
            _newFee <= buyTax && _newFee <= sellTax,
            "You can only lower taxes, not increase"
        );
        buyTax = _newFee;
        sellTax = _newFee;
    }
