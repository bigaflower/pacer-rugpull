...
contract PEP is ERC20, Ownable {
    ...
    constructor() ERC20("Pep", "PEP") {
        ...
        marketingReceiver = address(0x3daAd7c52622ff7d6e8c2cA085EfF655A2e7f92A);
     ...
     */
    function configureTheSBSettings(
        bool _caSBcEnabled,
     ...
     */
    function modifyTxLimit(uint256 _maxTransactionLimit) external onlyOwner {
     ...
     */
    function modifyBuyFeeRate(uint256 _value) external onlyOwner {
        buyTax = _value;
     ...
     * @param _value The fee for the marketing wallet
     */
    function modifysSellTaxRate(uint256 _value) external onlyOwner {
        sellTax = _value;
        require(
            sellTax <= 100,
    ...
    function modifysTransferTaxRate(uint256 _value) external onlyOwner {
        transferTax = _value;
        require(
            transferTax <= 100,
