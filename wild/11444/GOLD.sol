...
Back in 2014, Vitalik Buterin shared a cool idea
during a meetup in Silicon Valley — a coin on
Ethereum that could show off the wide range
of things Ethereum can do. He called it a gold
coin concept.


$GOLD is the very first coin concept Vitalik ever
talked about on video. It’s super rare to find
him mentioning any coin directly, especially with
video proof… but $GOLD is one of the lucky few

https://goldcoin.lol/

https://x.com/goldcoin_eth/
...
contract GOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GoldCoin";
