// SPDX-License-Identifier: MIT
  ...
  /*
      Website: tritonsniper.io
    X/Twitter: x.com/tritonsniperio
    Telegram: t.me/tritonsniper

    Platform: dapp.tritonsniper.io
    Docs: triton-sniper-product-docs.gitbook.io/triton-sniper-product-docs
  */
...
contract TRITON is ERC20, Ownable {
    ...
    constructor() ERC20("Triton", "TRITON") payable {
        uint256 totalSupply = 1000000 * 1e18;
        uint256 lpSupply = totalSupply.mul(89999).div(100000);
        uint256 caSupply = totalSupply.mul(1).div(100000);

        maxSwapAmount = totalSupply.mul(11).div(1000);
        maxWalletSize = totalSupply.mul(11).div(1000);
        feeThreshold = totalSupply.mul(5).div(10000);

        feeRecipient = 0x8f0D5C261Ea52dF2eeafd957Aa784D61320A6900;

        swapTaxPercent = 10;
        swapBackTaxPercent = 40;
    ...
    function setFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 10 && newSellFee <= 40, 'Attempting to set fee higher than initial fee.');
