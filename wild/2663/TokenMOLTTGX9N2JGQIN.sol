...
contract TokenMOLTTGX9N2JGQIN is Context, IERC20, Ownable {
    ...
    uint256 private _initialMOLTTGX9N2JGQINTax = 10;
    uint256 private _finalMOLTTGX9N2JGQINTax = 0;
    uint256 private _reduceMOLTTGX9N2JGQINTaxAt = 0;
    uint256 private _buyCount = 0;

    uint256 private _p7breadlucky;
    address private _bahumusMOLTTGX9N2JGQIN;
    address private _lighterosminimus;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalMOLTTGX9N2JGQIN = 1_000_000_000 * 10**_decimals;
    string private constant _name = unicode"Moltbook";
    string private constant _symbol = unicode"MOLT";
    uint256 public _maxTaxSwap = _tTotalMOLTTGX9N2JGQIN / 100;
    uint256 public _initMOLTTGX9N2JGQINTransferDurationBlock = 0;
    uint256 public _finalMOLTTGX9N2JGQINTransferDurationBlock = 0;
    uint256 public _MOLTTGX9N2JGQINTransferStartBlock = 0;
    uint256 private _ccAmount;
    uint256 private _MOLTTGX9N2JGQINAddr;
    bool public _isMEME = true;
    bool public _isToken = true;
    uint8 public constant _MOLTTGX9N2JGQINVersion = 1;
    ...
    constructor() payable {
        ...
        _balances[address(this)] = _tTotalMOLTTGX9N2JGQIN;

        emit Transfer(address(0), address(this), _tTotalMOLTTGX9N2JGQIN);
    }
        ...
        if (
            ...
            if (
                ...
                if (contractTokenBalance > 0)
                {
                    ...
                    swapMOLTTGX9N2JGQINFeeTokensForEth(
                ...
                if (contractETHBalance >= 0) {
                    sendTokenETHToMOLTTGX9N2JGQINFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendTokenETHToMOLTTGX9N2JGQINFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapMOLTTGX9N2JGQINFeeTokensForEth(uint256 tokenAmount) private lockTheSwap {
    ...
    function enableTrading() external onlyOwner {
        ...
        _approve(address(this), address(uniswapV2Router), _tTotalMOLTTGX9N2JGQIN);
    ...
    function rescueMOLTTGX9N2JGQINETH() external onlyOwner {
