...
Buckaru The White PikaChu 

GameStop briefly teased (then deleted) a Feb 12 Pokémon drop on https://x.com/powerpacks

A homepage banner appeared, then vanished. Site code confirms a “Lightning” limited drop featuring Buckaru, whose ability is “HODL.” The Diamond pack shows a diamond hands logo.

This is the combination of two metas: POKEMON + GME 

Their official partnership, Buck was their mascot and Buckaru the new Pokémon, this is free marketing. 

powerpacks.com
https://t.me/Buckarueth
https://x.com/buckaruoneth
*/ 
...
contract buckaru is Context, IERC20, Ownable {
  ...
  uint8 private constant _decimals = 9;
    ...
    string private constant _name = unicode"Buckaru";
    string private constant _symbol = unicode"BUCKARU";
    ...
    function endLimit() external onlyOwner {
