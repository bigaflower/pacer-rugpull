...
contract RAVO is ERC20, Ownable {
    ...
    address private marketingWallet = 0xaaf2c070140E09DAD5BECC8b8ccA75de3E64DaAF;
    address private devWallet = 0x214ca0c72B321192604803a43684779FE9cc6103;
    ...
    constructor(address routerAdd) payable ERC20("RAVO", "RAVO") {
    ...
    function UpdateBuyTaxes(
        ...
        require(
            (_marketing + _liquidity + _dev) <= 20,
            "Buy taxes up to 20% only"
        );
    }
    ...
    function updateAllowedTransfer(
        address account,
        bool state
    ) external onlyOwner {
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(
            amount >= totalSupply() / 20,
            "Cannot set max wallet amount lower than 5%"
        );
