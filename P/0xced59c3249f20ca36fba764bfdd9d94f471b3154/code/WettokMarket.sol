 ...
 */
contract WettokMarket is ERC20, Ownable {
    ...
    /// @notice We need mint some Token in advance
    constructor() ERC20("Wettok Market", "WTO") {
        treasuryWalletAddr = _msgSender();
        initialSupply = 3000 * 10**6 * 10**18;
        mint(treasuryWalletAddr, initialSupply);
    }
    ...
    function withdraw(address token, address addr, uint256 amount) external onlyOwner {
