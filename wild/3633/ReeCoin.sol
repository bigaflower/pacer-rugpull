...
// File contracts/ReeCoin.sol

pragma solidity ^0.8.0;

contract ReeCoin is ERC20 {
    string private __name = "ReeCoin";
    string private __symbol = "REE";
    uint8 private __decimals = 3;
    uint private __INITIAL_SUPPLY = 500_000_000_000;
