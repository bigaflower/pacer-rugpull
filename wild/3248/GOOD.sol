/*
Vitalik is among the most charitable individuals in crypto-- if not number one. He has a clear sense
of what to support and what he stands for, all while putting in countless hours to improve Ethereum.
That combination is extremely rare— especially in crypto.

"I've said before that I think the best thing for memecoins is if they can be maximally positive-sum
for the world, so it's great to see moments when that actually happens!" - Vitalik in 2024

That’s why the Ethereum Is Good fund was launched. It supports Vitalik directly with a 1% allocation of $GOOD
and a 5/5 tax paid in native ETH to his wallet, vitalik.eth (0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045).
...
contract GOOD is ERC20, Ownable {
    ...
    constructor() ERC20("Ethereum Is Good", "GOOD") {
        ...
        // Set Fee Wallet
        devWallet = address(0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045); // set as dev wallet
