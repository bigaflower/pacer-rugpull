...
/*
    ...
    Domo is Japan’s lovable monster, born in the late ’90s. Before the likes of Labubu, 
    Domo was the legendary plush icon across Asia for decades.

    From Japanese TV to viral memes on the early internet, Domo became one of the web’s 
    first global memes, spreading across forums like 4chan, MySpace, and Reddit in the 2000s.

    Website: https://domokun.tokyo/
    Twitter : http://twitter.com/domokunerc
    Telegram: https://t.me/domokunerc
...
contract DOMO is Context, IERC20, Ownable {
    ...
    constructor() {
        _taxWallet = payable(0x09815F7594648e9937Ff498468302B68877c0f95);
