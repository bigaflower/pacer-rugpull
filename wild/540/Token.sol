/*
    Name: Ethereum Foundation Mascot
    Symbol: SHISHI

    SHISHI by @shiro57102 made it on the front cover of the ethereum foundation mandate The new mascot of the @ethereumfndn has been decided.

    https://shishionEth.fun
    https://t.me/shishionErc
    https://x.com/shishionErc
*/
...
contract Token is ERC20, Ownable {
    ...
    string private constant _OQWJEOIJT = "SHISHI";
    uint256 private constant _SHISHI = 2026;

    constructor() ERC20(unicode"Ethereum Foundation Mascot", unicode"SHISHI") payable {
