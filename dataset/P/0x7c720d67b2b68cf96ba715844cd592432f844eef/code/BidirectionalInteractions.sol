...
contract BidirectionalInteractions is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private constant _name = "Bidirectional Interactions";
    string private constant _symbol = "Super-Intelligence";
