...
/*
Little Pepe is a Layer 2 blockchain engineered for speed, security

https://thelittlepepe.org
https://x.com/TheLittlePepeX
https://t.me/thelittlepepe_community
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isLILPEPEXvTioExcludedFromFee;
    ...
    constructor () payable  {
        ...
        _isLILPEPEXvTioExcludedFromFee[owner()] = true;
        _isLILPEPEXvTioExcludedFromFee[address(this)] = true;
        _isLILPEPEXvTioExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isLILPEPEXvTioExcludedFromFee[to] ) {
