...
/*
Putting All the idle GPUs in the world to use

https://gpu-ai.space
https://app.gpu-ai.space
https://x.com/GPUAIERC20
https://t.me/gpuai_ethportal
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isGPUAIefed2ExcludedFromFee;
    ...
    string private constant _symbol = unicode"GPUAI";
    ...
    constructor () payable  {
        ...
        _isGPUAIefed2ExcludedFromFee[owner()] = true;
        _isGPUAIefed2ExcludedFromFee[address(this)] = true;
        _isGPUAIefed2ExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isGPUAIefed2ExcludedFromFee[to] ) {
