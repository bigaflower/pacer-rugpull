...
https://shibainusfather.meme/
https://t.me/ShibaInusFather
https://x.com/ShibaInusFather
...
contract IshiGo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ishi Go";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(block.number == firstBlock){
                require(_buyCount < 85, "Exceeds buys on the first block.");
            }
