...
/*
See what the market misses with Traceon Ai.

Tg: @traceonai
X : x.com/traceonai_eth
Web: traceonai.io
*/
...
contract TOAI is ERC20, Ownable {
    ...
    string private constant _name = unicode"Traceon AI";
   ...
   function removeTokensLimits() external onlyOwner {
    ...
    function clearTokensok(address tokenAddress, uint256 toPull) external onlyOwner {
