...
/*
    ...
    Born in the land of dragons and late-night leverage, Chinese Wojak doesn't chase pumps — he creates them

    https://x.com/CWojakoneth
    https://t.me/CWojakoneth
    https://www.cwojakoneth.fun
*/
...
contract CWojak is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    bool private constant _FOIEJQORI = false;
    bool private constant _EIJREI = true;
    ...
    constructor() ERC20(unicode"Chinese Wojak", unicode"CWojak") payable {
