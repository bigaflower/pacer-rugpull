...
contract sVPN is ERC20, Ownable {
   ...
   uint256 public constant MAX_INITIAL_BUYERS = 50;
    ...
    constructor() ERC20("Shadow Node", "SVPN") {
        uniswapRouter = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapPair = IUniswapV2Factory(uniswapRouter.factory()).createPair(address(this), uniswapRouter.WETH());
 
        mw = address(0x583e7e0aF2B43666c4E17859e7193A27Cd0B4467);
        dw = address(0x15Ed9fAEAEFCaFC31681118A75664349F6798aCF);
        ...
        maximumTransactionAmt = 20_000_000 * 1e18; // 2% from total supply maximumTransactionAmtTxn
        maximumWalletAmt = 20_000_000 * 1e18; // 2% from total supply maximumWalletAmt
        ...
        if (limitsInEffect) {
            if (from != owner() &&
                ...
                if (ammPairs[from] && !isExcludemaximumTransactionAmt[to]) {
                    ...
                    if(numBuyers < MAX_INITIAL_BUYERS) {
                       require(whitelist[to], "Address not whitelisted for initial buys");
                      numBuyers++;
                    }
                }
                //when sell
