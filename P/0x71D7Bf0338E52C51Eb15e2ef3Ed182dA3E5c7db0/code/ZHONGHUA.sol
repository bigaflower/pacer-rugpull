...
X: https://twitter.com/ZhongHua_ERC20
Tg: https://t.me/ZhongHua_Group
 */
...
contract ZHONGHUA is IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"名烟中華";
    string private constant _symbol = unicode"中華";
    ...
    function updateZhongTax(uint256 lpFee, uint256 devFee) external onlyOwner {
         _divideLpFee = lpFee; 
    ...
    function performZhongSwap() internal lockSwap {
    ...
    function adjustZhongWalletSize(uint256 percent) external onlyOwner {
