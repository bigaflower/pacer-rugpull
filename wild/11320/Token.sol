...
contract Token is Context, IERC20Metadata, Ownable {
  ...
  uint256 public constant marketingReserve = 2_133_333_333 * (10 ** _decimals);
  uint256 public constant communityRewardsReserve = 1_333_333_333 * (10 ** _decimals);
  ...
  constructor() {
    ...
    _mint(0x0693FBf94a7623FdB12E87C044DDa42DA2866256, communityRewardsReserve);
