...
contract TANUKI is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0x3255578a7C1F88AF53dD6D1536c4c614180bD18d);
    ...
    constructor(){
        _devWallet = payable(0x87cfc281EA5ddb059c4061519f8aAE3cB0f3F138);
    ...
    function addLPUniswap() external onlyOwner() {
        ...
        uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)),0,0,0x87cfc281EA5ddb059c4061519f8aAE3cB0f3F138,block.timestamp);
    ...
    function modifyMaxTxSwap(uint256 newTxSwap) external onlyOwner{
        _maxTaxSwap = newTxSwap * 10**_decimals;
    }
