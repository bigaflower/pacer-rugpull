...
TELEGRAM : 
https://t.me/lickeroneth
TWITTER : 
https://x.com/lickeroneth
WEBSITE : 
https://licker.wtf
*/
...
contract LICKER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Licker";
    string private constant _symbol = unicode"LICKER";
    ...
    constructor () {
        _taxWallet = payable(0x9dCdDFAe46033bF228CCbEa122BbcAC09d8ca39F);
