...
contract CINU is ERC20, Ownable {
    ...
    constructor() ERC20("Cult of Inu", "CINU") {
		...
		charityWallet = address(0x200FD241C1A26b5e84c5b68261206d5a4466ac0E); // set as charity wallet
        marketingWallet = address(0x200FD241C1A26b5e84c5b68261206d5a4466ac0E); // set as marketing wallet
        devWallet = address(0xD3426bb9f0de0EA3E871DAa4c291f678B2Bc7d2C); // set as dev wallet
