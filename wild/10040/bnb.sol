...
contract InitializableERC20 {
    ...
    constructor(address initialOwner, uint256 initialSupply, string memory _name, string memory _symbol, uint8 _decimals) public   
        
    {
        require(!initialized, "TOKEN_INITIALIZED");
        initialized = true;
        totalSupply = initialSupply;
        balances[initialOwner] = initialSupply;
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
