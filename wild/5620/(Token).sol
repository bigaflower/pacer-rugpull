...
contract US500_INDEX_SHORT is ERC20, ERC20Burnable, Ownable2Step, ERC20Permit, Initializable {
    ...
    constructor()
        ERC20(unicode"US500 INDEX SHORT", unicode"US500S")
        Ownable(msg.sender)
        ERC20Permit(unicode"US500 INDEX SHORT")
    {
    ...
    */
    ...
    function deploymentKey() external pure returns (bytes32) {
        return 0xfadca5474cc7e58c582bf6957916025ec122944630902882f5aef2cc38afcdae;
    }
