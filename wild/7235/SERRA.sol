...
contract SERRA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Serra Grok Companion";
    string private constant _symbol = unicode"SERRA";
