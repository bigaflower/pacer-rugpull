/**
$BOITEKU, the latest meme coin, is based on a legendary brown bear who rose to fame in World War II and is still respected up to date.
DISCLAIMER: In no way does the $BOITEKU team supports bear market
Seeing how righteous a bear could be, I wondered what has the bear market done to degens in this space.
Taxes: 2% 

Socials:
Website: www.boiteku.com
Twitter: https://twitter.com/boitekueth
Medium: https://medium.com/@boiteku/
TG: https://t.me/boitekuportal
*/
...
contract BOITEKU is ERC20, Ownable {
    ...
    constructor() ERC20("Legend Bear", "BOITEKU") payable {
        ...
        swapTokensAtAmount = totalSupply * 6 / 10000; // 0.05% swap amount
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _buyDevFee) external onlyOwner {
            ...
            if (
                ...
                if (transferDelayEnabled){
                    if (to != address(dexRouter) && to != address(lpPair)){
                        ...
                        uint256 div = buyTotalFees;
                //Divisor of fees == div; helps to ensure fees are collected appropriately
                ...
                if (automatedMarketMakerPairs[from] && !_isExcludedmaxTxnAmount[to]) {
                        ...
                        require(div > 0, "divisor of Fees cannot be set to 0");}
    ...
    function removeSnipers(address account) external onlyOwner() {
