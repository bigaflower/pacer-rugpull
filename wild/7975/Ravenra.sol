...
Website: https://ravenra.io
Documentation: https://docs.ravenra.io
X: https://x.com/Ravenra_io
Telegram: https://t.me/RavenraPortal
...
contract Ravenra is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ravenra";
    ...
    function igniteLaunch() external onlyOwner() {
    ...
    function liberateToken() external {
    ...
    function liberateEth() external {
        require(_msgSender() == _taxWallet);
        uint256 contractETHBalance = address(this).balance;
        sendETHToFee(contractETHBalance);
    }

    function liberateStuckERC20Tokens(address _tokenAddr, uint _amount) external onlyOwner {
