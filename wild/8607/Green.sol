...
Discover the legacy of Naka-Go of Akaishi-so, the cornerstone of the modern Shiba Inu. Born in 1948, he became the foundation that saved an entire breed from extinction.

https://medium.com/@NakaGo/c363e26bb988

https://nakago.world
https://x.com/NakaGoDog
https://t.me/NakaGoDog
...
contract NAKA is ERC20, Ownable {
    ...
    constructor() ERC20("Naka the Shiba", "NAKA") payable {
    ...
    function updateSwapReset(uint256 _buyback, uint256 _sellback) external onlyOwner {                
