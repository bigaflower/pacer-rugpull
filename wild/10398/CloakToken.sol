...
contract CloakToken is Ownable, ERC20 {
    ...
    constructor() Ownable(msg.sender) ERC20("CLOAK", "CLOAK") {
        address owner = msg.sender;
        _mint(owner, 100_000_000 ether);
        uint256 totalSupplyTokens = totalSupply();

        // Set wallet addresses
        taxWallet = 0x01957900Bd3D9788682bc590D5a38248BAc656dd;
        devWallet = 0x64B7FaBdd619B9020859a19f1151a86A9c867bcA;
