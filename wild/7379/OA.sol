/*
Website: https://omniagent.app/
DApp: https://dashboard.omniagent.app/
X: https://x.com/OmniAgent_App
Telegram Portal: https://t.me/OmniAgent
*/
...
contract OmniAgent is ERC20, Ownable {
    ...
    constructor() ERC20("OmniAgent", "OMAGENT", 8) {
        ...
        // 2.0% max transaction at launch
        maxTransaction = (totalSupply * 200) / 10_000; 
        // 2.0% max wallet at launch
        ...
        developmentWallet = 0x0a91429782Dab0388CAa1B53686994A521DD3BDc;
