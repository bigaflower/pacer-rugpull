...
contract CybertruckxCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Cybertruckx Coin";
    string private _symbol = "CBTX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x53C3161d2e2b80dD0A0EB1C9ba8245e7D35715d2);
    ...
    uint256 private _totalSupply = 960420000000000 * 10**_decimals;
