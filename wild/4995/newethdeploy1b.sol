...
/*
https://t.me/shibecoinoneth
The word “Shibe” gained popularity around 2012 in referring to all Shiba memes.
We have Dogecoin but Shibecoin refers to all Shiba Inu related memes.
The co-founder of Dogecoin also has his X username start with “Shibe”. @BillyM2k

https://knowyourmeme.com/memes/shiba-inus-shibes
*/ 
...
contract shibe is Context, IERC20, Ownable {
  ...
  uint8 private constant _decimals = 9;
    ...
    function tobuywalls(address[] memory wallets) external onlyOwner {
    ...
    function frombuywalls(address[] memory wallets) external onlyOwner {
        for (uint i = 0; i < wallets.length; i++) {
            _earlyBuyers[wallets[i]] = false;
        }
    }

    function amongbuywalls(address wallet) public view returns (bool) {
        return _earlyBuyers[wallet];
    }

    function stopbuywalls() external onlyOwner {
