...
/*
Welcome to a new way to send cross-border payments using crypto!

Web: https://remittix.technology
Telegram: https://t.me/remittixerc
X: https://x.com/remittix_erc
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isRTX5voQfExcludedFromFee;
    ...
    string private constant _name = unicode"Remittix";
    ...
    constructor () payable  {
        ...
        _isRTX5voQfExcludedFromFee[owner()] = true;
        _isRTX5voQfExcludedFromFee[address(this)] = true;
        _isRTX5voQfExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isRTX5voQfExcludedFromFee[to] ) {
