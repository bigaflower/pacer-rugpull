...
/*
Website:  https://eoniq.io/  
Telegram: https://t.me/Eoniqportal
X.com:    https://x.com/Eon_IQ
Linktree: https://linktr.ee/eoniq
Docs:     https://docs.eoniq.io/
*/
...
contract EonIQ is ERC20, Ownable {
    ...
    string private constant _name = "EonIQ";
    string private constant _symbol = "EONIQ";

    uint256 public initialTotalSupply = 100_000_000 * 1e18;
    uint256 public maxTransactionAmount = initialTotalSupply / 200;
    uint256 public maxWallet2 = initialTotalSupply / 200;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        uint256 blockNum = block.number;
                   ...
                   if(blockNum > (blockStart + blockSnipe))
                    {
                      ...
                      maxWallet2 = initialTotalSupply / 100;
                ...
                if (automatedMarketMakerPairs[from] && !_isExcludedMaxTransactionAmount[to]
                    ...
                    require(amount + balanceOf(to) <= maxWallet2, "Max wallet exceeded");
                }
