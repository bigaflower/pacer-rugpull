/*
    ...
    MEMS is an Ethereum meme token built for the culture of crypto memes. It represents the chaotic, creative, and unstoppable energy of the Ethereum community—where memes move faster than markets.

    https://ethmeme.vip
    https://t.me/ether_memes
    https://x.com/ether_memes
*/
...
contract Token is ERC20, Ownable {
    ...
    string private constant _OQWJEOIJT = "MEMES";
    bool private constant _DLFKDJSOIJ = true;

    constructor() ERC20(unicode"Ethereum Memes", unicode"MEMES") payable {
