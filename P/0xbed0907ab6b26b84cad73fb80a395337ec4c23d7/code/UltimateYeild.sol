...
contract UltimateYeild {

	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 1e22;  // 1e21 =  1000  // 1e24 = 1M
	uint256 constant private BURN_RATE = 99; // 10% per tx
	uint256 constant private SUPPLY_FLOOR = 1; // 1% of 1M = 10k
	uint256 constant private MIN_FREEZE_AMOUNT = 1e18; // 100

	string constant public name = "UltimateYield";
	string constant public symbol = "ULY";
