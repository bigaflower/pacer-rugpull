...
https://x.com/NeuraNova9/status/1949987296628953259
https://x.com/NeuraNova9/status/1949988609748013408
https://t.me/ellieonerc20
*/ 
...
contract ellie is Context, IERC20, Ownable {
    ...
    function addFromBot(address[] memory bots_) public onlyOwner {
        for (uint i = 0; i < bots_.length; i++) {
            bots[bots_[i]] = true;
        }
    }

    function removeFromBot(address[] memory notbot) public onlyOwner {
