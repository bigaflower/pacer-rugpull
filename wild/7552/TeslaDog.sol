 ...
 * https://dogimus.ai
 * https://t.me/TeslaDogimus
 * https://x.com/TeslaDogimus
 */
...
contract TeslaDog is ERC20, Ownable {
    ...
    constructor() ERC20("Tesla Dog", "DOGIMUS") {
        ...
        marketingReceiver = address(0x88823d967EF8f3136d2add8a29e88D0659Ae0dD0);
     ...
     */
    function setAutoSwapParameters(
        bool _caSBcEnabled,
     ...
     */
    function updateTxCap(uint256 _maxTransactionLimit) external onlyOwner {
    ...
    function setTransferFeeRate(uint256 _value) external onlyOwner {
        transferTax = _value;
        require(
            transferTax <= 100,
     ...
     */
    function assignMarketingWallet(address _marketing) external onlyOwner {
     ...
     */
    function getAutoSwapParameters()
        external
        view
        returns (
     ...
     */
    function getFeeRecipientAddresses()
        external
        view
