//WEB: HTTPS://FATHEROFPEPE.XYZ

//TG:HTTPS://T.ME/FatherofPepe_official

//X:HTTPS://X.com/FatherofPepe
...
contract FatherOfPepe is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Father of Pepe";
    ...
    function reduceFee(uint256 _newBuyFee, uint256 _newSellFee)
        external
        onlyOwner
    {
        require(
