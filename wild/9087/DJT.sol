...
Memecoin based on donald trump, we are more than the Election, we are about betting on donald trump the crypto dark horse!

https://t.me/djtcoin_erc

https://x.com/DJTCOIN_ERC
...
contract DJT is ERC20, Ownable {
    ...
    constructor() ERC20("Donald Trump", "DJT") payable {
        uint256 totalSupply = 420690000000 * 1e9;

        feeReceiver = 0x1fe55AdB1fB7B6761237a3D14d5163d345dAC40E;
        buyFeeProcent = 30;
        sellFeeProcent = 30;
