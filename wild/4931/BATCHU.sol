/*
    ...
    https://x.com/VitalikButerin/status/1576270648103489536

    Batman vs Pikachu meme coin: logic meets lightning, belief beats code, and memes decide the winner — Vitalik

    https://batchu.vip
    https://x.com/BatmanvsPikachu
    https://t.me/BatmanvsPikachu
*/
...
contract BATCHU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Batman vs Pikachu";
    string private constant _symbol = unicode"BATCHU";
