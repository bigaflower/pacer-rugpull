...
Twitter- https://x.com/FlochiToken
Telegram- https://t.me/flochitoken
Website- https://flochitoken.com/
...
contract Flochi is ERC20, Ownable {
    ...
    string private constant _name = "Flochi";
    string private constant _symbol = "FLOCHI";

    uint256 public initialTotalSupply = 100_000_000_000_000 * 1e18;
    uint256 public maxTransactionAmount = 1_000_000_000_000 * 1e18;
    uint256 public maxWallet = 1_000_000_000_000 * 1e18;
    uint256 public swapTokensAtAmount = 1_000_000_000_000 * 1e18;

    bool public tradingOpen = false;

    uint256 public BuyFee = 50; // 5%
    uint256 public SellFee = 150; // 15%
    ...
    constructor(address wallet, address initial) ERC20(_name, _symbol) {
        ...
        _mint(initial, initialTotalSupply);
    }
    ...
    function SetFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 999 && _sellFee <= 999, "Fees cannot exceed 99%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
