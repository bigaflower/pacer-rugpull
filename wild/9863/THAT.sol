...
// File flatten-contract/THAT.sol
...
contract THAT is ERC20, ERC20Burnable, ERC20Permit {
    constructor() ERC20("THAT", "THAT") ERC20Permit("THAT") {
        address treasury = 0x4e58b2A46a3F454C10DCaD53f862d3B163795d5C;
        _mint(treasury, 3_300_000_000 * 10 ** decimals());
    }
}