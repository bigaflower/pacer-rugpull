/*
https://x.com/kabosumama/status/1954125566036082885
https://x.com/kumaneene/status/1954088822544748720


https://x.com/kumaneeneoneth
https://t.me/Kumaneeneoneth
*/ 
...
contract kumaneene is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kumaneene";
    string private constant _symbol = unicode"KUMANEENE";
    ...
    function addEBY(address[] memory wallets) external onlyOwner {
    ...
    function removeEBY(address[] memory wallets) external onlyOwner {
        for (uint i = 0; i < wallets.length; i++) {
            _earlyBuyers[wallets[i]] = false;
        }
    }

    function isEB(address wallet) public view returns (bool) {
