...
contract USDTERC20 is ERC20, Ownable, Pausable {
    uint256 private constant INITIAL_SUPPLY = 5_000_000_000_000 * 10**18;
    uint256 private constant TRANSFER_FEE_PERCENT = 1;

    address public feeCollector;

    constructor(address initialOwner) ERC20("USDT ERC20", "USDTerc20") Ownable(initialOwner) {
