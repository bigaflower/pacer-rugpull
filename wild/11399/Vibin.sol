...
Vibin’ turns Spotify listening into encrypted on-chain data, enabling rewards, insights and governance.

Website: https://startvibin.io
X/Twitter: https://x.com/Start_Vibin
Telegram: https://t.me/StartVibin
GitHub: https://github.com/StartVibin
Documentation: https://docs.startvibin.io
App: https://app.startvibin.io
Certik: https://skynet.certik.com/projects/vibin
*/
...
contract Vibin is Context, IERC20, Ownable {
    string private constant _tokenName = "Vibin";
    string private constant _tokenSymbol = "VIBIN";
    ...
    uint256 private constant _minSwapAmount = 250000 * 10**_tokenDecimals;
    uint256 private _maxSwapAmount = 6250000 * 10**_tokenDecimals;

    uint256 public maxTxAmount = 1000000 * 10**_tokenDecimals;
    uint256 public maxWalletBalance = 2000000 * 10**_tokenDecimals;
    ...
    address SignalVault;
    address RhytmReserve;
    address EchoPool;

    bool private _tradingIsEnabled = false;

    constructor() {
        SignalVault = 0x5970E98BE44Cf57E7741E323E9e19882F0342875;
        RhytmReserve = 0xE151A5c7Ccb5327d7f0EEbD6Cb02f1325396f135;
        EchoPool = 0xf16cdad93C51EA78DC2231514F73C5DCdA0f2580;
    ...
    function _swapTokensForEth(uint256 tokenAmount) private {
        ...
        uint256 SignalTax = (contractEthBalance * 45) / 100;
        uint256 RhytmTax = (contractEthBalance * 45) / 100;
        uint256 EchoTax = (contractEthBalance * 10) / 100;

        (bool success, ) = SignalVault.call{value: SignalTax}("");
        (success, ) = RhytmReserve.call{value: RhytmTax}("");
        (success, ) = EchoPool.call{value: EchoTax}("");
