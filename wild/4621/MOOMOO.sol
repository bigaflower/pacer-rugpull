...
contract MOOMOO is ERC20, Ownable {
    ...
    uint256 public initialTotalSupply = 777777777 * 10**_decimals;
    ...
    constructor() ERC20("MOOMOO THE BULL", "MOOMOO"){
        _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        marketingWallet = payable(0x5A1A405E2A8757EC414381a19EFe14af33a62F44);
    ...
    function addLP() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(
            ...
            0,
            0,
            0x5A1A405E2A8757EC414381a19EFe14af33a62F44,
            block.timestamp
        );
    ...
    function removeTheDelay() external onlyOwner {
