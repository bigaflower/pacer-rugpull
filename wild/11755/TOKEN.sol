...
X: https://x.com/aladdinai_eth

TG: https://t.me/aladdinai_eth
...
contract TOKEN is ERC20, Ownable {
    ...
    constructor()
        ERC20("Aladdin AI", "ALADDIN")
    {   
        _mint(msg.sender, 10 * (10 ** 11) * (10 ** 18));
        ...
        swapTokensAtAmt = totalSupply() * 30 / 100000; // 1% = 1000
