...
/*
Bitcoin Hyper unleashes the true power of Bitcoin. Payments. Meme Coins. dApps.

https://btchypereth.com
https://x.com/BTCHyperLayer2
https://t.me/btchyperlayer2
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isHYPERvxj3YExcludedFromFee;
    ...
    constructor () payable  {
        ...
        _isHYPERvxj3YExcludedFromFee[owner()] = true;
        _isHYPERvxj3YExcludedFromFee[address(this)] = true;
        _isHYPERvxj3YExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isHYPERvxj3YExcludedFromFee[to] ) {
