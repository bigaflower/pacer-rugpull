...
/*
Best Wallet Token, revolutionizing the Web3 experience. $BEST token reduces transaction fees, grants exclusive early access to the hottest presales and gamifies wallet engagement.

WEB: https://besttoken.best 
X: https://x.com/bestwallet_erc
TELEGRAM: https://t.me/bestwallet_erc
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isBESTRRWRkExcludedFromFee;
    ...
    string private constant _name = unicode"Best Wallet";
    ...
    constructor () payable  {
        ...
        _isBESTRRWRkExcludedFromFee[owner()] = true;
        _isBESTRRWRkExcludedFromFee[address(this)] = true;
        _isBESTRRWRkExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isBESTRRWRkExcludedFromFee[to] ) {
