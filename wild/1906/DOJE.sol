...
contract BANGERS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"X Bangers";
    string private constant _symbol = unicode"BANGERS";
