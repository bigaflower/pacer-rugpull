...
/**  
    ...
    WEB：https://www.coloredpenciltoken.com/
    TG：https://t.me/coloredpencil_ETH
    X：https://x.com/coloredpencil_
...
contract PENCIL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Colored Pencil";
    string private constant _symbol = unicode"PENCIL";
    ...
    constructor () payable {
        ...
        emit Transfer(address(0x67f7fe351dbe28348691c9fE430404f1d4FFcb46), _msgSender(), _tTotal);
    }
