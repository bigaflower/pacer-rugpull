...
/*
Put token description here (if you wish), dont forget to update social links
...
contract MNRA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Munira";
    string private constant _symbol = unicode"MNRA";
