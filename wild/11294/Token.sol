...
https://x.com/playfirstxi

https://t.me/PlayFirstXI

https://www.instagram.com/playfirstxi
...
contract Token is ERC20, Ownable {
    ...
    function handleTax(address from, address to, uint256 amount) internal returns (uint256){
        ...
        if(taxes.totalTax > 0){
            ...
            if(launchBlock == block.number){
                ...
                if (isAMMPair[from] || isAMMPair[to]){
                    tax = uint128(amount * 7000 / FEE_DIVISOR);
                }
    ...
    function DisperseAirdrop(address[] calldata recipients, uint256[] calldata amounts) external onlyOwner {
