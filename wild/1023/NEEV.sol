/*
    $NEEV - not just another token. It is the system. Inside the metallic coin, the cold figure in dark glasses watches every move.

    Website: https://neevoneth.site
    Twitter: https://x.com/neevoneth
    Telegram: https://t.me/neevoneth
*/
...
contract NEEV is ERC20, Ownable {
    ...
    string private constant _ConstructSymbol = "NEEV";

    constructor() ERC20(unicode"NotInEmploymentEducationVitalik", unicode"NEEV") payable {
