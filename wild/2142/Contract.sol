...
/*
https://x.com/ethereum/status/1914379758499942530#ref=cee82c51-fb2f-4602-bccd-037f5f5b25dc
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ethereum is for you";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot815(address a) public view returns (bool){
      return bots[a];
    }
