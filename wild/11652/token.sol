...
/*
Doink appears first on the cover of Cortex Vortex, setting the tone with his signature melting skull and surreal intensity—a fitting introduction to Matt Furie’s latest dive into visual chaos.

https://www.instagram.com/beuys_on_sale/
https://mattfurie.com/page/2/
https://mattfurie.com/wp-content/uploads/2019/07/Doink_In_Peace_LO-copy.jpg

https://t.me/doink_erc20
https://x.com/doink_erc20
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _0xFTXZ2098 = 20;
    uint256 private _x3KLVQ5082 = 20;
    uint256 private _x7PRXTZ = 0;
    uint256 private _x5NLYW9028 = 0;
    uint256 private _x2BQVT655 = 20;
    uint256 private _xGRWZ23 = 20;
    uint256 private _x1PLYT7F7 = 20;
    ...
    uint256 public _x6NRWPX7 = (_tTotal * 1) / 100;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            taxAmount = amount
                .mul((_buyCount > _x2BQVT655) ? _x7PRXTZ : _0xFTXZ2098)
                .div(100);
            ...
            if (
                ...
                require(
                    balanceOf(to) + amount <= _x0BRXT5K7,
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                taxAmount = amount
                    .mul((_buyCount > _xGRWZ23) ? _x5NLYW9028 : _x3KLVQ5082)
                    .div(100);
            }
            ...
            if (
                ...
                to == uniswapV2Pair &&
                swapEnabled &&
                contractTokenBalance > _x6NRWPX7 &&
                _buyCount > _x1PLYT7F7
            ) {
