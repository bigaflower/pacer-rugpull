...
/*
    Doge moves from meme timeline to ETF watchlist as institutional attention grows.
    This cycle is no longer just retail hype. Doge In Vest reads order flow, sentiment shifts, and ETF speculation to separate narrative noise from investable momentum.

    https://dogeinvest.dog
    https://x.com/DogeInVestCoin
    https://t.me/DogeInVestCoin
*/
...
contract INVEST is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Doge In Vest", unicode"INVEST") payable {
